...
<div id="navbar"> 
        ...
        <div class="title-container">
            <div class="another-container1">
                <div class="title-slider"> <!-- images the one sa top left -->
                        <div><img src="images/umm al quwain/Discover/Khor Al Beidah/uaqdisD1.JPG" class="picture" /></div>
                        <div><img src="images/umm al quwain/Discover/Khor Al Beidah/uaqdisD2.JPG" class="picture" /></div>
                        <div><img src="images/umm al quwain/Discover/Khor Al Beidah/uaqdisD3.JPG" class="picture" /></div>
                </div>
            </div>
            <div class="another-container">
                <h1 class="title1"> Khor Al Beidah </h1> <!-- title -->
    ...
    <div class="wrapper2">
        <div class="info-hist-box" id="history">
         ...
         <div class="layer1">
            ...
            <h2 class="info-title"> Information </h2> <!-- images on the left -->
                <div class="img-set"><img src="images/umm al quwain/Discover/Khor Al Beidah/uaqdisD4.JPG" class="smallimg"/></div>
                <div class="img-set"><img src="images/umm al quwain/Discover/Khor Al Beidah/uaqdisD1.JPG" class="smallimg"/></div>
                <div class="img-set"><img src="images/umm al quwain/Discover/Khor Al Beidah/uaqdisD2.JPG" class="smallimg"/></div>
            </div>
            <div class="info-container">
                <div class="dl-bm">
                    ...
                    <a href="download/Umm Al Quwain/Discovery/Khor Al Beidah.docx"> 
                    <button><img src="images/Desktop Download.png"/></button>
                    </a>
                    
                </div>
            <h2 class="info-title1"> Information </h2> <!-- description feel free to add per paragraph -->
                <p class="info-description"> Less than an hour from Dubai lie the Khor Al Beidah wetlands, it is an untouched haven for birds and birdwatchers alike. 
                A patchwork of pristine beaches, emerald blue lagoons, hidden islands and dense mangroves, the wetlands are home to both endemic and migratory birds, 
                including difficult to spot species like the Great Knot and the Clab Plover. 


                    <br>
                    <br>
                    
                    Besides its attraction for bird watchers, Khor Al Beidah also provides adventure enthusiasts a great opportunity for kayaking and a chance to explore 
                    first hand, this unique ecosystem, which offers a rare insight into the Arabian Peninsula apart from the quintessential desert association.
        ...
        <div class="blackbg">
        <img src="images/umm al quwain/Discover/Khor Al Beidah/uaqdisD3.JPG" class="wtd-bg"/> <!-- the bg for the entirety of the what to do part -->
        </div>
        <div class="scroller-area">
            ...
            <div class="contents-box">
                ...
                With a unique ecosystem, blue lagoons and hidden islands, this place is nothing short of thrilling.                </div>
            </div> 
            
            <div class="contents-box">
                <div class="contents-img">
                    <img src="images/umm al quwain/Discover/Khor Al Beidah/uaqdisD4.JPG" />
                </div>
                <div class="contents-container">
                <h2 class="contents-title"> Bird Watching </h2>
                <p class="contents-desc">

                <br><br>

                In the island, you’ll see a variety of bird species including marbled duck, red-breasted merganser, 
                Eurasian bittern, merlin and so much more.  
...
<!-- -->
    ...
    <section id="media-wrappper">
        ...
        <div class="row row1">
            <div class="img-media"><img src="images/umm al quwain/Discover/Khor Al Beidah/uaqdisD4.JPG" class="fiximg" />
            <p> Flamingos </p>
            </div>

            <div class="img-media"><img src="images/umm al quwain/Discover/Khor Al Beidah/uaqdisD1.JPG" class="fiximg" />
            <p> Scenery in Khor Al Beidah </p>
            </div>
            
            <div class="img-media"><img src="images/umm al quwain/Discover/Khor Al Beidah/uaqdisD3.JPG" class="fiximg" />
            <p> A different view of Khor Al Beidah </p>
            </div>

            <div class="img-media"><img src="images/umm al quwain/Discover/Khor Al Beidah/uaqdisD2.JPG" class="fiximg" />
            <p> A woman walking in Khor Al Beidah </p>
            </div>
