...
<head>
    ...
    <title>Observation Deck at 300</title>
...
<body>
        ...
        <div class="title-container">
            <div class="another-container1">
                <div class="title-slider"> <!-- images the one sa top left -->
                        <div><img src="images\auh-pictures\Dine\Observation Deck at 300\auhdin1A.jpg" class="picture" /></div>
                        <div><img src="images\auh-pictures\Dine\Observation Deck at 300\auhdin1B.jpg" class="picture" /></div>
                        <div><img src="images\auh-pictures\Dine\Observation Deck at 300\auhdin1D.jpg" class="picture" /></div>
                </div>
            </div>
            <div class="another-container">
                <h1 class="title1"> OBSERVATION DECK AT 300 </h1> <!-- title -->
    ...
    <div class="wrapper2">
        ...
        <div class="layer1">
            ...
            <h2 class="info-title"> Information </h2> <!-- images on the left -->
                ...
                <div class="img-set"><img src="images\auh-pictures\Dine\Observation Deck at 300\auhdin1E.jpg" class="smallimg"/></div>
                <div class="img-set"><img src="images\auh-pictures\Dine\Observation Deck at 300\auhdin1G.jpg" class="smallimg"/></div>
                <div class="img-set"><img src="images\auh-pictures\Dine\Observation Deck at 300\auhdin1H.jpg" class="smallimg"/></div>
            ...
            <div class="info-container">
                ...
                <div class="dl-bm">
                    ...
                    <a href="download\Abu Dhabi\Dine\Observation Deck at 300.docx"> 
            ...
            <h2 class="info-title1"> Information </h2> <!-- description feel free to add per paragraph -->
                ...
                <p class="info-description"> 
                    ...
                    Located on Level 74, Tower 2, the Observation Deck at 300 offers the highest vantage of Abu Dhabi's 
                    cityscape and guests can enjoy delicious refreshments and the city's highest high tea against a 
    ...
    <!-- to be replaced -->
    <!-- virtual tour -->
    <iframe width="100%" height="1000px" src="https://poly.google.com/view/0Q9WAT18TWo/embed?chrome=min" frameborder="0" style="border:none;" allowvr="yes" allow="vr; xr; accelerometer; magnetometer; gyroscope; autoplay;" allowfullscreen mozallowfullscreen="true" webkitallowfullscreen="true" onmousewheel="" ></iframe>   

    <!-- google maps -->   
    <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d14527.14262766823!2d54.3216462!3d24.4582208!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0xc98170eb2833ebc3!2sObservation%20Deck%20at%20300!5e0!3m2!1sen!2sae!4v1622735571244!5m2!1sen!2sae"
    ...
    <section id="media-wrappper">
        ...
        <div class="row row1">
            <div class="img-media">
                <img src="images\auh-pictures\Dine\Observation Deck at 300\auhdin1A.jpg" class="fiximg" /> <!-- img! -->
                 <!-- description time, add smth like idk "fun time family!" -->
                <p> An assortment of biscuits and desserts sold at Observation Deck at 300  </p>
            </div>
            
            <div class="img-media">
                <img src="images\auh-pictures\Dine\Observation Deck at 300\auhdin1B.jpg" class="fiximg" /> <!-- img! -->
                 <!-- description time, add smth like idk "fun time family!" -->
                <p> The aesthetically pleasing tables from the cafe </p>
            </div>

            <div class="img-media">
                <img src="images\auh-pictures\Dine\Observation Deck at 300\auhdin1C.jpg" class="fiximg" /> <!-- img! -->
                 <!-- description time, add smth like idk "fun time family!" -->
                <p> Skyview from the Observation Deck </p>
            </div>

            <div class="img-media">
                <img src="images\auh-pictures\Dine\Observation Deck at 300\auhdin1D.jpg" class="fiximg" /> <!-- img! -->
                 <!-- description time, add smth like idk "fun time family!" -->
                <p> The observation deck telescopes </p>
            </div>

            <div class="img-media">
                <img src="images\auh-pictures\Dine\Observation Deck at 300\auhdin1E.jpg" class="fiximg" /> <!-- img! -->
                 <!-- description time, add smth like idk "fun time family!" -->
                <p> A different view from the deck </p>
            </div>
        </div>
        
        <div class="row row2">
            <div class="img-media">
                <img src="images\auh-pictures\Dine\Observation Deck at 300\auhdin1F.jpg" class="fiximg" /> <!-- img! -->
                 <!-- description time, add smth like idk "fun time family!" -->
                <p> A family dining at Observation Deck at 300 </p>
            </div>

            <div class="img-media">
                <img src="images\auh-pictures\Dine\Observation Deck at 300\auhdin1G.jpg" class="fiximg" /> <!-- img! -->
                 <!-- description time, add smth like idk "fun time family!" -->
                <p> Another variety of desserts </p>
            </div>
            
            <div class="img-media">
                <img src="images\auh-pictures\Dine\Observation Deck at 300\auhdin1H.jpg" class="fiximg" /> <!-- img! -->
                 <!-- description time, add smth like idk "fun time family!" -->
                <p> Colorful assortment biscuits from Conrad </p>
            </div>
