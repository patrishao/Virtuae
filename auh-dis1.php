...
<body>
        ...
        <div class="title-container">
            <div class="another-container1">
                <div class="title-slider"> <!-- images the one sa top left -->
                        <div><img src="images\auh-pictures\Discover\Louvre Abu Dhabi\auhdis1G.jpg" class="picture" /></div>
                        <div><img src="images\auh-pictures\Discover\Louvre Abu Dhabi\auhdis1C.jpg" class="picture" /></div>
                        <div><img src="images\auh-pictures\Discover\Louvre Abu Dhabi\auhdis1D.jpg" class="picture" /></div>
                </div>
            </div>
            <div class="another-container">
                <h1 class="title1"> LOUVRE ABU DHABI </h1> <!-- title -->
    ...
    <div class="wrapper2">
        <div class="info-hist-box" id="history">
         ...
         <div class="layer1">
            ...
            <h2 class="info-title"> Information </h2> <!-- images on the left -->
                ...
                <div class="img-set"><img src="images\auh-pictures\Discover\Louvre Abu Dhabi\auhdis1A.jpg" style="object-position: 0 -50px;" class="smallimg"/></div>
                <div class="img-set"><img src="images\auh-pictures\Discover\Louvre Abu Dhabi\auhdis1H.jpg" class="smallimg"/></div>
                <div class="img-set"><img src="images\auh-pictures\Discover\Louvre Abu Dhabi\auhdis1B.jpg" class="smallimg"/></div>
            ...
            <div class="info-container">
                ...
                <div class="dl-bm">
                    ...
                    <a href="download\Abu Dhabi\Discover\Louvre Abu Dhabi.docx"> 
            ...
            <h2 class="info-title1"> Information </h2> <!-- description feel free to add per paragraph -->
                ...
                <p class="info-description"> 
                    ...
                    The museum is located on the Saadiyat Island Cultural District. It is approximately 24,000 square 
                    metres in size, with 8,000 square metres of galleries, making it the largest art museum in the Arabian 
                    peninsula.
                ...
                <p class="info-description1"> 
                    ...
                    The origins of Louvre Abu Dhabi date back to March 2007. The UAE and France formed an unprecedented 
                    partnership for cultural exchange, and the highlight of this would be the establishment of Louvre 
                    Abu Dhabi on Saadiyat Island. The partnership would combine the UAE’s bold vision of cultural 
                    progression and openness, with France’s expertise in the world of art and museums. It would 
                    explore the shared themes that reveal and connect humanity.

                    <br><br>

                    The result is Louvre Abu Dhabi. It represents the dynamic nature of the contemporary Arab world while 
                    celebrating the region’s vibrant multicultural heritage. Agence France-Muséums – 17 of France’s most 
                    renowned cultural institutions – coordinates the loan of artworks to this UAE museum and provides 
        ...
        <div class="blackbg">
        <img src="images\auh-pictures\Discover\Louvre Abu Dhabi\auhdis1A.jpg" class="wtd-bg"/> <!-- the bg for the entirety of the what to do part -->
        </div>
        <div class="scroller-area">
            ...
            <div class="contents-box">
                <div class="contents-container1">
                    ...
                    <p class="contents-desc1">
                        ...
                        Louvre Abu Dhabi is a new cultural beacon, bringing different cultures together to shine fresh light 
                        on the shared stories of humanity.
            ...
            <div class="contents-box">
                <div class="contents-img">
                    <img src="images\auh-pictures\Discover\Louvre Abu Dhabi\auhdis1H.jpg" />
                </div>
                <div class="contents-container">
                    <h2 class="contents-title"> Galleries </h2>
                    <p class="contents-desc"> 

                        The museum galleries tell a chronological history of human creativity that explores 
                        the shared ideas and issues that have defined our common humanity from pre-history 
                        to the present.
            ...
            <div class="contents-box">
                <div class="contents-img">
                    <img src="images\auh-pictures\Discover\Louvre Abu Dhabi\auhdis1D.jpg" />
                </div>
                <div class="contents-container">
                    <h2 class="contents-title"> Make&Play </h2>
                    <p class="contents-desc">

                        Make and Play are short, fun videos for all the family to make art inspired by the 
                        collection using simple materials.
            ...
            <div class="contents-box">
                <div class="contents-img">
                    <img src="images\auh-pictures\Discover\Louvre Abu Dhabi\auhdis1G.jpg" />
                </div>
                <div class="contents-container">
                    <h2 class="contents-title"> Kayaking </h2>
                    <p class="contents-desc">

                        Enjoy the museum from the stillness of the Arabian Sea. Take a tour on a kayak 
                        and learn all about Louvre Abu Dhabi’s architecture from a unique perspective. 
    ...
    <!-- to be replaced -->
    <!-- virtual tour -->
    <iframe width="100%" height="1000px" src="https://poly.google.com/view/cRb6o1tkGXD/embed?chrome=min" frameborder="0" style="border:none;" allowvr="yes" allow="vr; xr; accelerometer; magnetometer; gyroscope; autoplay;" allowfullscreen mozallowfullscreen="true" webkitallowfullscreen="true" onmousewheel="" ></iframe>
    
    <!-- google maps -->   
    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3629.6063468169955!2d54.39594811428147!3d24.53370026431947!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3e5e6724630067f1%3A0x42191ffb02753df9!2sLouvre%20Abu%20Dhabi!5e0!3m2!1sen!2sae!4v1622844752597!5m2!1sen!2sae"
    ...
    <section id="media-wrappper">
        ...
        <div class="row row1">
            <div class="img-media">
                <img src="images\auh-pictures\Discover\Louvre Abu Dhabi\auhdis1A.jpg" class="fiximg" /> <!-- img! -->
                 <!-- description time, add smth like idk "fun time family!" -->
                <p> Light filters creating an enchanting effect within the museum, <br> known as the 'rain of light' </p>
            </div>
            
            <div class="img-media">
                <img src="images\auh-pictures\Discover\Louvre Abu Dhabi\auhdis1B.jpg" class="fiximg" /> <!-- img! -->
                 <!-- description time, add smth like idk "fun time family!" -->
                <p> A greek statue exhibit in Louvre Abu Dhabi </p>
            </div>

            <div class="img-media">
                <img src="images\auh-pictures\Discover\Louvre Abu Dhabi\auhdis1C.jpg" class="fiximg" /> <!-- img! -->
                 <!-- description time, add smth like idk "fun time family!" -->
                <p> Nouvel's dome </p>
            </div>

            <div class="img-media">
                <img src="images\auh-pictures\Discover\Louvre Abu Dhabi\auhdis1D.jpg" class="fiximg" /> <!-- img! -->
                 <!-- description time, add smth like idk "fun time family!" -->
                <p> View of the Arabian Sea from Louvre Abu Dhabi </p>
            </div>

            <div class="img-media">
                <img src="images\auh-pictures\Discover\Louvre Abu Dhabi\auhdis1E.jpg" class="fiximg" /> <!-- img! -->
                 <!-- description time, add smth like idk "fun time family!" -->
                <p> View of Nouvel's Dome from outside </p>
            </div>
        </div>
        <div class="row row2">
            <div class="img-media">
                <img src="images\auh-pictures\Discover\Louvre Abu Dhabi\auhdis1F.jpg" class="fiximg" /> <!-- img! -->
                 <!-- description time, add smth like idk "fun time family!" -->
                <p> An orchestra concert being held in Louvre Abu Dhabi </p>
            </div>

            <div class="img-media">
                <img src="images\auh-pictures\Discover\Louvre Abu Dhabi\auhdis1G.jpg" class="fiximg" /> <!-- img! -->
                 <!-- description time, add smth like idk "fun time family!" -->
                <p> Kayaking in the Arabian Sea by Louvre Abu Dhabi </p>
            </div>
            
            <div class="img-media">
                <img src="images\auh-pictures\Discover\Louvre Abu Dhabi\auhdis1H.jpg" class="fiximg" /> <!-- img! -->
                 <!-- description time, add smth like idk "fun time family!" -->
                <p> Visitors roaming in one of the exhibits </p>
            </div>
    ...
    <script>
        ...
        function sun(){
            ...
            $('#t-time').html('10:00 AM to 6:30 PM'); //so put the timings here
