...
<head>
    ...
    <title>The Buried Village of Al Madam</title>
...
<div id="navbar"> 
        ...
        <div class="title-container">
            <div class="another-container1">
                <div class="title-slider"> <!-- images the one sa top left -->
                        <div><img src="images/dubai/dxbdis1C.jpg" class="picture" /></div>
                        <div><img src="images/dubai/discover/dxbdis1B.jpg" class="picture" /></div>
                        <div><img src="images/dubai/discover/dxbdis1A.jpg" class="picture" /></div>
                </div>
            </div>
            <div class="another-container">
                <h1 class="title1"> The Buried Village of Al Madam </h1> <!-- title -->
    ...
    <div class="wrapper2">
        <div class="info-hist-box" id="history">
         ...
         <div class="layer1">
            ...
            <h2 class="info-title"> Information </h2> <!-- images on the left -->
                <div class="img-set"><img src="images/dubai/discover/dxbdis1D.jpg" style="object-position: 0 -50px;" class="smallimg"/></div>
                <div class="img-set"><img src="images/dubai/discover/dxbdis1E.jpg" style="object-position: 0 -50px;" class="smallimg"/></div>
                <div class="img-set"><img src="images/dubai/discover/dxbdis1G.jpg" style="object-position: 0 -50px;" class="smallimg"/></div>
            </div>
            <div class="info-container">
                <div class="dl-bm">
                    ...
                    <a href="download/Dubai/Discover/The Buried Village of Al Madam.docx"> 
        ...
        <div class="blackbg">
        <img src="images/dubai/discover/dxbdis1C.jpg" class="wtd-bg"/> <!-- the bg for the entirety of the what to do part -->
        </div>
        <div class="scroller-area">
            ...
            <div class="contents-box">
                ...
                <p class="contents-desc1">Explore different ways to experience this place.</p>
                 </div>
            </div> 
            
            <div class="contents-box">
                <div class="contents-img">
                    <img src="images/dubai/discover/dxbdis1E.jpg"/>
                </div>
                <div class="contents-container">
                <h2 class="contents-title"> Sightseeing </h2>
                <p class="contents-desc">
                Looking at the awesome Dubai skyline with its epic range of towering skyscrapers, it’s difficult to comprehend that not too far from the city is a mysterious ghost village gradually being consumed by the desert.</p> <!-- put the actual activities here -->
                 </div>
            </div> 

            <div class="contents-box">
                <div class="contents-img">
                    <img src="images/dubai/discover/dxbdis1B.jpg"/>
                </div>
                <div class="contents-container">
                <h2 class="contents-title"> Experience </h2>
                <p class="contents-desc">
    ...
    <iframe src="https://www.google.com/maps/embed?pb=!4v1622824525377!6m8!1m7!1sCAoSLEFGMVFpcE1RdnFEWEE3azlqMk5zQ2J3OHRzcDNoRmkzUlJ5aDdTdUk2NDJN!2m2!1d24.8948936!2d55.7641333!3f59.77272727272726!4f-0.8143939393939519!5f0.4000000000000002" width="100%" height="1000px" style="border:0;" allowfullscreen="" loading="lazy"></iframe>
    <!-- google maps -->   
    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3619.0905258749935!2d55.7641333!3d24.8948936!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3ef573e3ff3cda5b%3A0xadf9a244b475f30c!2sAl%20Madam%20-%20Buried%20%22Ghost%22%20Village!5e0!3m2!1sen!2sae!4v1622824552112!5m2!1sen!2sae"
...
<!-- -->
    ...
    <section id="media-wrappper">
        ...
        <div class="row row1">
            <div class="img-media"><img src="images/dubai/discover/dxbdis1A.jpg" class="fiximg" />
            <p> The Buried Village of Al Madam </p>
            </div>

            <div class="img-media"><img src="images/dubai/discover/dxbdis1B.JPG" class="fiximg" />
            <p> The Buried Village of Al Madam </p>
            </div>

            <div class="img-media"><img src="images/dubai/discover/dxbdis1C.JPG" class="fiximg" />
            <p> The Buried Village of Al Madam </p>
            </div>

            <div class="img-media"><img src="images/dubai/discover/dxbdis1D.jpg" class="fiximg" />
            <p> The Buried Village of Al Madam </p>
            </div>

            <div class="img-media"><img src="images/dubai/discover/dxbdis1E.jpg" class="fiximg" />
            <p> The Buried Village of Al Madam </p>
            </div>
