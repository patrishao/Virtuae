...
<head>
    ...
    <title>Bait Obaid Al Shams</title>
...
<body>
        ...
        <div class="title-container">
            <div class="another-container1">
                <div class="title-slider"> <!-- images the one sa top left -->
                        <div><img src="images\shj-pictures\Sights to See\Bait Obaid Al Shams\shjsts2A.JPG" class="picture" /></div>
                        <div><img src="images\shj-pictures\Sights to See\Bait Obaid Al Shams\shjsts2B.JPG" class="picture" /></div>
                </div>
            </div>
            <div class="another-container">
                <h1 class="title1"> BAIT OBAID AL SHAMS </h1> <!-- title -->
    ...
    <div class="wrapper2">
        <div class="info-hist-box" id="history">
         ...
         <div class="layer1">
            ...
            <h2 class="info-title"> Information </h2> <!-- images on the left -->
                <div class="img-set"><img src="images\shj-pictures\Sights to See\Bait Obaid Al Shams\shjsts2D.JPG" class="smallimg"/></div>
                <div class="img-set"><img src="images\shj-pictures\Sights to See\Bait Obaid Al Shams\shjsts2E.JPG" class="smallimg"/></div>
                <div class="img-set"><img src="images\shj-pictures\Sights to See\Bait Obaid Al Shams\shjsts2F.JPG" class="smallimg"/></div>
            </div>
            <div class="info-container">
                <div class="dl-bm">
                    ...
                    <a href="download\Sharjah\Sights to See\Bait Obaid Al Shams.docx"> 
            ...
            <h2 class="info-title1"> Information </h2> <!-- description feel free to add per paragraph -->
                ...
                Particularly interesting are the two rooms on the roof that face the creek, connected by a terrace. Their five long windows are framed with equally wide panels and decorated with charcoal-stained floral motifs.
                 ...
                 <h2 class="info-title"> History </h2>
                   ...
                   The house in the Al Shuwaiheen neighbourhood was built around 1845, and owned by the merchant Obaid Bin Hamad Al Shamsi. Around a large courtyard there are 13 rooms on the ground floor and 3 more on the upper floor.
                    </p>                     
        ...
        <div class="blackbg">
        <img src="images\shj-pictures\Sights to See\Bait Obaid Al Shams\shjsts2C.JPG" class="wtd-bg"/> <!-- the bg for the entirety of the what to do part -->
        </div>
        <div class="scroller-area">
            ...
            <div class="contents-box">
                ...
                <p class="contents-desc1">Their five long windows are framed with equally wide panels and decorated with charcoal-stained floral motifs.</p>
                 </div>
            </div> 
            
            <div class="contents-box">
                <div class="contents-img">
                    <img src="images\shj-pictures\Sights to See\Bait Obaid Al Shams\shjsts2D.JPG" />
                </div>
                <div class="contents-container">
                <h2 class="contents-title"> Scenery </h2>
                <p class="contents-desc"> Like many heritage houses in the area, Bait Obaid Al Shamsi was inhabited until the 1970s. In 1997, the building complex was partially restored, and a another restoration took place in 2017-2018. </p> <!-- put the actual activities here -->
                 </div>
            </div> 
            
            <div class="contents-box">
                <div class="contents-img">
                    <img src="images\shj-pictures\Sights to See\Bait Obaid Al Shams\shjsts2F.JPG" />
                </div>
                <div class="contents-container">
                <h2 class="contents-title"> Exhibits </h2>
                <p class="contents-desc"> Bait Obaid Al Shamsi serves as a venue for contemporary art exhibitions and events, artist studios and residencies. Beginning with SB9 in 2009, it is used by the Sharjah Biennial as a temporary exhibition venue. </p> <!-- put the actual activities here -->
                 </div>
            </div> 
    ...
    <!-- to be replaced -->
    <!-- virtual tour -->
    <iframe width="100%" height="1000px" src="https://poly.google.com/view/1KOonI9HNAN/embed?chrome=min" frameborder="0" style="border:none;" allowvr="yes" allow="vr; xr; accelerometer; magnetometer; gyroscope; autoplay;" allowfullscreen mozallowfullscreen="true" webkitallowfullscreen="true" onmousewheel="" ></iframe>
     <!-- google maps -->   
     <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3605.2809067011976!2d55.384957050927746!3d25.361900331142234!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3e5f5a3a18f7afb5%3A0xb4f79b12ed4ddea1!2sSharjah%20Art%20Foundation%20-%20Bait%20Obaid%20Al%20Shamsi!5e0!3m2!1sen!2sae!4v1622928628916!5m2!1sen!2sae" width="100%" height="500" style="border:0;" allowfullscreen="" loading="lazy"></iframe>
    ...
    <section id="media-wrappper">
        ...
        <div class="row row1">
            <div class="img-media">
                <img src="images\shj-pictures\Sights to See\Bait Obaid Al Shams\shjsts2A.JPG" class="fiximg" /> <!-- img! -->
                 <!-- description time, add smth like idk "fun time family!" -->
                <p> sunny day </p>
            </div>
            
            <div class="img-media">
                <img src="images\shj-pictures\Sights to See\Bait Obaid Al Shams\shjsts2B.JPG" class="fiximg" /> <!-- img! -->
                 <!-- description time, add smth like idk "fun time family!" -->
                <p> the sun setting with people </p>
            </div>

            <div class="img-media">
                <img src="images\shj-pictures\Sights to See\Bait Obaid Al Shams\shjsts2C.JPG" class="fiximg" /> <!-- img! -->
                 <!-- description time, add smth like idk "fun time family!" -->
                <p> scenic picture </p>
            </div>

            <div class="img-media">
                <img src="images\shj-pictures\Sights to See\Martyrs Square and Monument\shjsts1D.JPG" class="fiximg" /> <!-- img! -->
                 <!-- description time, add smth like idk "fun time family!" -->
                <p> doorways </p>
            </div>

            <div class="img-media">
                <img src="images\shj-pictures\Sights to See\Martyrs Square and Monument\shjsts1E.JPG" class="fiximg" /> <!-- img! -->
                 <!-- description time, add smth like idk "fun time family!" -->
                <p> a giant chessboard </p>
            </div>
        </div>
        <div class="row row2">
        <div class="img-media">
            ...
            <div class="img-media">
                <img src="images\shj-pictures\Sights to See\Bait Obaid Al Shams\shjsts2D.JPG" class="fiximg" /> <!-- img! -->
                 <!-- description time, add smth like idk "fun time family!" -->
                <p> doorways </p>
            </div>

            <div class="img-media">
                <img src="images\shj-pictures\Sights to See\Bait Obaid Al Shams\shjsts2E.JPG" class="fiximg" /> <!-- img! -->
                 <!-- description time, add smth like idk "fun time family!" -->
                <p> a giant chessboard </p>
            </div>
            <div class="img-media">
        ...
        <div class="img-media">
            ...
            <div class="img-media">
                <img src="images\shj-pictures\Sights to See\Martyrs Square and Monument\shjsts1C.JPG" class="fiximg" /> <!-- img! -->
                 <!-- description time, add smth like idk "fun time family!" -->
                <p> night at the monument </p>
            </div>
            <div class="img-media">
                <img src="images\shj-pictures\Sights to See\Bait Obaid Al Shams\shjsts2C.JPG" class="fiximg" /> <!-- img! -->
                 <!-- description time, add smth like idk "fun time family!" -->
