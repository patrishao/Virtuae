...
<body>
        ...
        <div class="title-container">
            <div class="another-container1">
                <div class="title-slider"> <!-- images the one sa top left -->
                        <div><img src="images\shj-pictures\Entertainment\Al Qasba\shjent4A.JPG" class="picture" /></div>
                        <div><img src="images\shj-pictures\Entertainment\Al Qasba\shjent4D.JPG" class="picture" /></div>
                        <div><img src="images\shj-pictures\Entertainment\Al Qasba\shjent4C.JPG" class="picture" /></div>
                </div>
            </div>
            <div class="another-container">
                <h1 class="title1"> Al Qasba </h1> <!-- title -->
    ...
    <div class="wrapper2">
        <div class="info-hist-box" id="history">
         ...
         <div class="layer1">
            ...
            <h2 class="info-title"> Information </h2> <!-- images on the left -->
                <div class="img-set"><img src="images\shj-pictures\Entertainment\Al Qasba\shjent4G.JPG" class="smallimg"/></div>
                <div class="img-set"><img src="images\shj-pictures\Entertainment\Al Qasba\shjent4E.JPG" class="smallimg"/></div>
                <div class="img-set"><img src="images\shj-pictures\Entertainment\Al Qasba\shjent4C.JPG" class="smallimg"/></div>
            </div>
            <div class="info-container">
                <div class="dl-bm">
                    ...
                    <a href="download\Sharjah\Entertainment\Al Qasba.docx"> 
            ...
            <h2 class="info-title1"> Information </h2> <!-- description feel free to add per paragraph -->
                ...
                Among the most popular places to visit in Sharjah at night, Al Qasba is the complete experience for anyone 
                looking to tour on foot. With pedestrian bridges and a canal-side complex, this destination is sure to 
                inspire fun for everyone.


                    <br> 
                    <br>
                    
                    Al Qasba Sharjah is a waterfront community that is separated from Al Majaz District by Al Khan Corniche 
                    Street. Al Qasba in Sharjah is a cultural landmark that features art centres, outdoor attractions and 
                    a number of other attractions. This picturesque community is at the forefront of the cultural movement 
                    in Sharjah and aims to fuel creative minds with a number of activities, events and leisure options.
                   ...
                   Al Qasba opened to the public in the Year 2005.
        ...
        <div class="blackbg">
        <img src="images\shj-pictures\Entertainment\Al Qasba\shjent4A.JPG" class="wtd-bg"/> <!-- the bg for the entirety of the what to do part -->
        </div>
        <div class="scroller-area">
            ...
            <div class="contents-box">
                ...
                The reason that this community is prominent among culture vultures and artists is that it 
                features several creative venues such as the Al Qasba theatre and art centres. Find out 
                more about what to expect when visiting the Al Qasba community.
                </p>
                </div>
            </div> 
            ...
            <div class="contents-box">
                ...
                <img src="images\shj-pictures\Entertainment\Al Qasba\shjent4H.JPG"/> <!-- the bg for the entirety of the what to do part -->
                </div>
                <div class="contents-container">
                <h2 class="contents-title"> Boats </h2>
                <p class="contents-desc"> 
                Unwind with your loved ones on a relaxing traditional “Abra” boat ride under 
                the stars. 
            ...
            <div class="contents-box">
                <div class="contents-img">
                <img src="images\shj-pictures\Entertainment\Al Qasba\shjent4I.JPG"/> <!-- the bg for the entirety of the what to do part -->
                </div>
                <div class="contents-container">
                <h2 class="contents-title"> Wireworld </h2>
                <p class="contents-desc">
                Elevate FUN and Welcome to Wire World AL QASBA. Unique sport oriented outdoor 
                activities; packed with fun, excitement and adventures for the entire family. 
                </p> 
                 </div>
            </div> 
            ...
            <div class="contents-box">
                <div class="contents-img">
                <img src="images\shj-pictures\Entertainment\Al Qasba\shjent4E.JPG"/> <!-- the bg for the entirety of the what to do part -->
                </div>
                <div class="contents-container">
                <h2 class="contents-title"> Funzone </h2>
                <p class="contents-desc">
                The Kids Fun Zone is a stimulating world of excitement for children of all 
                ages where they can socialize, interact and develop with their peers.
                </p> 
                 </div>
            </div> 
            ...
            <div class="contents-box">
                <div class="contents-img">
                <img src="images\shj-pictures\Entertainment\Al Qasba\shjent4G.JPG"/> <!-- the bg for the entirety of the what to do part -->
                </div>
                <div class="contents-container">
                <h2 class="contents-title"> Waterkarts </h2>
                <p class="contents-desc">
                Water Karts marine amusements provides an innovative, eco-friendly electric 
                water kart that has proven to be a hit around the world. 
    ...
    <!-- to be replaced -->
    <!-- virtual tour -->
    <iframe width="100%" height="1000px" src="https://poly.google.com/view/fhYGOahJGNK/embed?chrome=min" 
     ...
     <!-- google maps -->   
    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3606.4603065523306!2d55.376432!3d25.322330499999996!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3e5f5b9474ef66a3%3A0x713a89a36c11ed8c!2sAl%20KhanAl%20Qasba%20-%20Sharjah!5e0!3m2!1sen!2sae!4v1622835443105!5m2!1sen!2sae"
    ...
    <section id="media-wrappper">
        ...
        <div class="row row1">
            <div class="img-media">
            <img src="images\shj-pictures\Entertainment\Al Qasba\shjent4A.JPG" class="fiximg" /> <!-- img! -->
            <p> Al Qasba's Boat "Abra" rides </p>
            </div>
            
            <div class="img-media">
            <img src="images\shj-pictures\Entertainment\Al Qasba\shjent4B.JPG" class="fiximg" /> <!-- img! -->
            <p> Al Qasba's Boat "Abra" rides </p>
            </div>

            <div class="img-media">
            <img src="images\shj-pictures\Entertainment\Al Qasba\shjent4C.JPG" class="fiximg" /> <!-- img! -->
            <p> Al Qasba's Boat "Abra" rides </p>
            </div>

            <div class="img-media">
            <img src="images\shj-pictures\Entertainment\Al Qasba\shjent4D.JPG" class="fiximg" /> <!-- img! -->
            <p> Overview of Al Qasba </p>
            </div>

            <div class="img-media">
            <img src="images\shj-pictures\Entertainment\Al Qasba\shjent4E.JPG" class="fiximg" /> <!-- img! -->
            <p> Bridge of Al Qasba at night </p>
            </div>
        </div>
        <div class="row row2">
            <div class="img-media">
            <img src="images\shj-pictures\Entertainment\Al Qasba\shjent4F.JPG" class="fiximg" /> <!-- img! -->
            <p> Overview of Al Qasba </p>
            </div>

            <div class="img-media">
            <img src="images\shj-pictures\Entertainment\Al Qasba\shjent4G.JPG" class="fiximg" /> <!-- img! -->
            <p> Bridge of Al Qasba at the morning </p>
            </div>
            
            <div class="img-media">
            <img src="images\shj-pictures\Entertainment\Al Qasba\shjent4H.JPG" class="fiximg" /> <!-- img! -->
            <p> Al Qasba's Boat "Abra" rides </p>
            </div>

            <div class="img-media">
            <img src="images\shj-pictures\Entertainment\Al Qasba\shjent4I.JPG" class="fiximg" /> <!-- img! -->
            <p> Ferris wheel in Al Qasba </p>
            </div>
    ...
    <script>
        ...
        function sun(){
            ...
            $('#t-time').html('8:00 AM : 11:59 PM'); //so put the timings here
