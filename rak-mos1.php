...
<div id="navbar"> 
        ...
        <div class="title-container">
            <div class="another-container1">
                <div class="title-slider"> <!-- images the one sa top left -->
                        <div><img src="images/RAK/Mosque/Sheikh Zayed Mosque (2)/rakmos2D.jpg" class="picture" /></div>
                        <div><img src="images/RAK/Mosque/Sheikh Zayed Mosque (2)/IMG_2478.jpg" class="picture" /></div>
                        <div><img src="images/RAK/Mosque/Sheikh Zayed Mosque (2)/rakmos2F.jpg" class="picture" style="object-position: 0 -85px;"/></div>
                </div>
            </div>
    ...
    <div class="wrapper2">
        <div class="info-hist-box" id="history">
         ...
         <div class="layer1">
            ...
            <h2 class="info-title"> Information </h2> <!-- images on the left -->
                <div class="img-set"><img src="images/RAK/Mosque/Sheikh Zayed Mosque (2)/rakmos2G.jpg" style="object-position: 0 -100px;" class="smallimg"/></div>
                <div class="img-set"><img src="images/RAK/Mosque/Sheikh Zayed Mosque (2)/rakmos2H.jpg" style="object-position: 0 -200px;" class="smallimg"/></div>
                <div class="img-set"><img src="images/RAK/Mosque/Sheikh Zayed Mosque (2)/rakmos2A.jpg" style="object-position: 0 -150px;" class="smallimg"/></div>
            </div>
            <div class="info-container">
                <div class="dl-bm">
                    ...
                    <a href="download/Ras Al Khaimah/Mosque/Sheikh Zayed Mosque.docx"> 
                    <button><img src="images/Desktop Download.png"/></button>
                    </a>
                    
                </div>
            <h2 class="info-title1"> Information </h2> <!-- description feel free to add per paragraph -->
                <p class="info-description">Sheikh Zayed Mosque is one of the most recognizable buildings in Ras al-Khaimah. It is a common point of reference.
                    <br>
                    <br>

                    There are a number of mosques in Ras al Khaimah. The best known mosques in the emirate are Sheikh Zayed Mosque, Darwaish Mosque,
                     Sulaiman Bin Hajar Mosque, SaifMishary Mosque, and Jamey Farnaz Mosque.


                    <br>
                    <br>

                    It is on the old Al Qawasim Corniche road in the Dafan Al Khor neighborhood.
        ...
        <div class="blackbg">
        <img src="images/RAK/Mosque/Sheikh Zayed Mosque (2)/rakmos2G.jpg" class="wtd-bg"/> <!-- the bg for the entirety of the what to do part -->
        </div>
        <div class="scroller-area">
            ...
            Shiekh Zayed Mosque is one of the best known mosques in Ras Al Khaimah. The mosque has a rich architecture and importance 
            to the citizens of Ras Al Khaimah.
                </p>
                 </div>
            </div> 
            ...
            <div class="contents-box">
                <div class="contents-img">
                    <img src="images/RAK/Mosque/Sheikh Zayed Mosque (2)/rakmos2E.jpg"  />
                </div>
                <div class="contents-container">
                <h2 class="contents-title"> Visit </h2>
                <p class="contents-desc">
              While you're on the way, take a quick visit and just glance at the amazing architecture this mosque has and discover
              it's importance.   </p> <!-- put the actual activities here -->
                 </div>
            </div> 
            ...
            <div class="contents-box">
                <div class="contents-img">
                    <img src="images/RAK/Mosque/Sheikh Zayed Mosque (2)/rakmos2D.jpg" />
                </div>
                <div class="contents-container">
                <h2 class="contents-title"> Pray </h2>
                <p class="contents-desc">
                This is a place where people can pray to Allah. </p> <!-- put the actual activities here -->
                 </div>
            </div> 
            ...
            <div class="contents-box">
                <div class="contents-img">
                    <img src="images/RAK/Mosque/Sheikh Zayed Mosque (2)/rakmos2C.jpg" />
                </div>
                <div class="contents-container">
                <h2 class="contents-title"> Worship </h2>
                <p class="contents-desc">
                Mosques are sacred places for worshipping Allah.
    ...
    <h2 class="vt-title">TOUR & LOCATION</h2>
     ...
     <iframe width="100%" height="1000px" src="https://poly.google.com/view/2CSx9R6hbDy/embed?chrome=min" 
     frameborder="0" style="border:none;" allowvr="yes" allow="vr; xr; accelerometer; magnetometer; gyroscope; autoplay;" allowfullscreen mozallowfullscreen="true" webkitallowfullscreen="true" onmousewheel="" ></iframe>
         ...
         <br>
              ...
              <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d14371.900911631417!2d55.9321313165117!3d25.77138176518997!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3ef6741d7ddbc09d%3A0xf14657e6d368fae8!2sSheikh%20Zayed%20Mosque!5e0!3m2!1sen!2sae!4v1622812439354!5m2!1sen!2sae" 
