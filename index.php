   ...
   <div class="adv-wrapper">  
     ...
     <div class="adv-container"> 
      ...
      <div class="adventure-places">
       ...
       <img src="images/dubai/dxbact3A (1).jpg" class="margin" >
      ...
      <div class="adventure-places">
       ...
       <img src="images/ajman/ajmact1A.jpg" class="margin" >
       ...
       <img src="images/dubai/dxbact2C.jpg" class="margin">
 ...
 <a name= "dine-link"></a>
   ...
   <h1 class="dine-heading"  >BEST PLACES TO DINE</h1>
    ...
    <div class="dine-wrapper">
      ...
      <!-- all restaurants -->
         <a class="restaurants first-res" href="rak-din1.php">  
          ...
          <a class="restaurants" href="rak-din4.php">
