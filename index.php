...
<div class="nav"> 
 <?php include 'includes/headers.php'; ?> 
   ...
   <div class="pages"> 
    ...
    <a href="#destinations-link">1</a>  <!-- linking -->
      <br>
    <!-- hr tag and made it vertical line it to the Top Destinations section-->
    <hr width="1px" size="40px"> 
    <a>2</a>
    <br>
    <!-- hr tag and made it vertical line -->
    <hr width="1px" size="110px"> 
    <a>3</a>
