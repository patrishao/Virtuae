...
<div id="navbar"> 
        ...
        <div class="title-container">
            <div class="another-container1">
                <div class="title-slider"> <!-- images the one sa top left -->
                        <div><img src="images/dubai/alsalam.JPG" class="picture" /></div>
                        <div><img src="images/dubai/mosque/salam1.JPG" class="picture" /></div>
                        <div><img src="images/dubai/mosque/salam2.JPG" class="picture" /></div>
                </div>
            </div>
            <div class="another-container">
                <h1 class="title1"> Al Salam Mosque </h1> <!-- title -->
    ...
    <div class="wrapper2">
        <div class="info-hist-box" id="history">
         ...
         <div class="layer1">
            ...
            <h2 class="info-title"> Information </h2> <!-- images on the left -->
                <div class="img-set"><img src="images/dubai/mosque/salam6.JPG" style="object-position: 0 -50px;" class="smallimg"/></div>
                <div class="img-set"><img src="images/dubai/mosque/salam5.JPG" style="object-position: 0 -50px;" class="smallimg"/></div>
                <div class="img-set"><img src="images/dubai/mosque/salam3.JPG" style="object-position: 0 -50px;" class="smallimg"/></div>
            </div>
            ...
            <h2 class="info-title1"> Information </h2> <!-- description feel free to add per paragraph -->
                <p class="info-description">Al Salam Mosque is one of the most magnificent mosques located in Al Barsha behind Mall of the Emirates. Its capacity is of 1,500 worshippers with a separate prayer hall for females and a separate hall for Iftar. Its design is inspired by the Andalusian and Ottoman architectural style. The multiple domes arranged in a pyramid-like fashion draw architecture lovers from across the region. The two minarets are eye-catching, while the mosque has attractive stained glass windows.
                </p>   
            </div>
        ...
        <div class="blackbg">
        <img src="images/dubai/mosque/salam4.JPG" class="wtd-bg"/> <!-- the bg for the entirety of the what to do part -->
        </div>
        <div class="scroller-area">
            ...
            <div class="contents-box">
                ...
                <p class="contents-desc1">See one of the stunning mosques in Dubai – a city of Islamic heritage and culture.</p>
                 </div>
            </div> 
            
            <div class="contents-box">
                <div class="contents-img">
                    <img src="images/dubai/mosque/salam2.JPG"/>
                </div>
                <div class="contents-container">
                <h2 class="contents-title"> Sightseeing </h2>
                <p class="contents-desc">
                Non-Muslims are not allowed to enter the mosque, however they can appreciate the mosque’s architecture from the outside.</p> <!-- put the actual activities here -->
                 </div>
            </div> 

            <div class="contents-box">
                <div class="contents-img">
                    <img src="images/dubai/mosque/salam5.JPG"/>
                </div>
                <div class="contents-container">
                <h2 class="contents-title"> Photo </h2>
                <p class="contents-desc">
                External photography of the facade is permitted. </p> <!-- put the actual activities here -->
                 </div>
            </div> 
        </div>
        </div>
    ...
    <iframe src="https://www.google.com/maps/embed?pb=!4v1622853194904!6m8!1m7!1sCAoSLEFGMVFpcFAtRGhKb095azA2ZWZKUGJZQ0xYbzBxZHdlNjlOSkJxQklnSmRG!2m2!1d25.10717646962293!2d55.20557888077781!3f238.53228044787295!4f1.4365924809250998!5f0.7820865974627469" width="100%" height="1000px" style="border:0;" allowfullscreen="" loading="lazy"></iframe>
    <!-- google maps -->   
    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3612.8429682193996!2d55.20557888077781!3d25.10717646962293!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3e5f6bed1c29a687%3A0x1386f8270f4272e7!2sAl%20Salam%20Masjid!5e0!3m2!1sen!2sae!4v1622853242704!5m2!1sen!2sae"
...
<!-- -->
    ...
    <section id="media-wrappper">
        ...
        <div class="row row1">
            <div class="img-media"><img src="images/dubai/mosque/salam1.jpg" class="fiximg" />
            <p> Al Salam Mosque </p>
            </div>

            <div class="img-media"><img src="images/dubai/mosque/salam2.JPG" class="fiximg" />
            <p> Al Salam Mosque </p>
            </div>

            <div class="img-media"><img src="images/dubai/mosque/salam3.jpg" class="fiximg" />
            <p> Al Salam Mosque </p>
            </div>

            <div class="img-media"><img src="images/dubai/mosque/salam4.JPG" class="fiximg" />
            <p> Al Salam Mosque </p>
            </div>

            <div class="img-media"><img src="images/dubai/mosque/salam5.jpg" class="fiximg" />
            <p> Al Salam Mosque </p>
            </div>
    ...
    <script>
        ...
        function sun(){
            ...
            $('#t-time').html(' N/A '); //so put the timings here
