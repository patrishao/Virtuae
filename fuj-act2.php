...
<body>
        ...
        <div class="title-container">
            <div class="another-container1">
                <div class="title-slider"> <!-- images the one sa top left -->
                        <div><img src="images\fuj-pictures\Activities\Fujairah Museum\fujact2A.JPG" class="picture" /></div>
                        <div><img src="images\fuj-pictures\Activities\Fujairah Museum\fujact2B.JPG" class="picture" /></div>
                        <div><img src="images\fuj-pictures\Activities\Fujairah Museum\fujact2D.JPG" class="picture" /></div>
                </div>
            </div>
            <div class="another-container">
                <h1 class="title1"> FUJAIRAH MUSEUM </h1> <!-- title -->
    ...
    <div class="wrapper2">
        <div class="info-hist-box" id="history">
         ...
         <div class="layer1">
            ...
            <h2 class="info-title"> Information </h2> <!-- images on the left -->
                <div class="img-set"><img src="images\fuj-pictures\Activities\Fujairah Museum\fujact2E.JPG" class="smallimg"/></div>
                <div class="img-set"><img src="images\fuj-pictures\Activities\Fujairah Museum\fujact2F.JPG" class="smallimg"/></div>
                <div class="img-set"><img src="images\fuj-pictures\Activities\Fujairah Museum\fujact2H.JPG" class="smallimg"/></div>
            </div>
            <div class="info-container">
                <div class="dl-bm">
                    ...
                    <a href="download\Fujairah\Activities\Fujairah Museum.docx"> 
            ...
            <h2 class="info-title1"> Information </h2> <!-- description feel free to add per paragraph -->
                ...
                It covers famous places like Ajman Museum and the Ajman Beach, Fujairah Emirate's oldest mosque Al Bidiya, Sharjah Urban attractions and Khor Fakkan beach. Drive through the busy streets and experience local life of the people and take an exciting walk through the colorful and aromatic markets.
                The Fujairah Museum houses a unique collection of archaeological finds exhibiting the history and heritage of the United Arab Emirates. The museum showcases the recent excavations of Qidfa and Bithna sites.
        ...
        <div class="blackbg">
        <img src="images\fuj-pictures\Activities\Fujairah Museum\fujact2B.JPG" class="wtd-bg"/> <!-- the bg for the entirety of the what to do part -->
        </div>
        <div class="scroller-area">
            ...
            <div class="contents-box">
                ...
                <p class="contents-desc1">Those who want to know more about Fujairah Museum will be excited to know that in 1969, this place was just a room that showcased old coins, tools, pottery and weapons. </p>
                 </div>
            </div> 
            
            <div class="contents-box">
                <div class="contents-img">
                    <img src="images\fuj-pictures\Activities\Fujairah Museum\fujact2A.JPG" />
                </div>
                <div class="contents-container">
                <h2 class="contents-title"> Exhibits </h2>
                <p class="contents-desc">Highlights the occupation of the region including trade, fishing and agriculture as well as pottery and weaving culture. </p> <!-- put the actual activities here -->
                 </div>
            </div> 
            
            <div class="contents-box">
                <div class="contents-img">
                    <img src="images\fuj-pictures\Activities\Fujairah Museum\fujact2I.JPG" />
                </div>
                <div class="contents-container">
                <h2 class="contents-title"> Halls </h2>
                <p class="contents-desc">The museum has multiple halls, each highlighting different aspects of how life once was in the emirate.  </p> <!-- put the actual activities here -->
                 </div>
            </div> 
    ...
    <!-- to be replaced -->
    <!-- virtual tour -->
    <iframe width="100%" height="1000px" src="https://poly.google.com/view/4p_ZDv4z2yK/embed?chrome=min"  
     ...
     <!-- google maps -->   
    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d461630.64367242047!2d55.12037774928436!3d25.321353537211927!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3ef4f87e03e9da29%3A0x59245307613ba75f!2sFujairah%20Museum!5e0!3m2!1sen!2sae!4v1622756368846!5m2!1sen!2sae"
    ...
    <section id="media-wrappper">
        ...
        <div class="row row1">
            <div class="img-media">
                <img src="images\fuj-pictures\Activities\Fujairah Museum\fujact2A.JPG" class="fiximg" /> <!-- img! -->
                 <!-- description time, add smth like idk "fun time family!" -->
                <p> entrance to the museum </p>
            </div>
            
            <div class="img-media">
                <img src="images\fuj-pictures\Activities\Fujairah Museum\fujact2B.JPG" class="fiximg" /> <!-- img! -->
                 <!-- description time, add smth like idk "fun time family!" -->
                <p> a scenic shot of the museum </p>
            </div>

            <div class="img-media">
                <img src="images\fuj-pictures\Activities\Fujairah Museum\fujact2C.JPG" class="fiximg" /> <!-- img! -->
                 <!-- description time, add smth like idk "fun time family!" -->
                <p> a better shot of the museum </p>
            </div>

            <div class="img-media">
                <img src="images\fuj-pictures\Activities\Fujairah Museum\fujact2E.JPG" class="fiximg" /> <!-- img! -->
                 <!-- description time, add smth like idk "fun time family!" -->
                <p> a higher view of the museum </p>
            </div>

            <div class="img-media">
                <img src="images\fuj-pictures\Activities\Fujairah Museum\fujact2F.JPG" class="fiximg" /> <!-- img! -->
                 <!-- description time, add smth like idk "fun time family!" -->
                <p> another scenenic shot of the museum</p>
            </div>
        </div>
        <div class="row row2">
            <div class="img-media">
            ...
            <div class="img-media">
                <img src="images\fuj-pictures\Activities\Fujairah Museum\fujact2G.JPG" class="fiximg" /> <!-- img! -->
                 <!-- description time, add smth like idk "fun time family!" -->
                <p> a nice image of the museum </p>
            </div>
    ...
    <script>
        ...
        function sun(){
            ...
            $('#t-time').html('8:00 AM - 6:30 PM'); //so put the timings here
        ...
        function fri(){
            $('#timing-info').hide().fadeIn();
            $('#t-time').html('2:30 PM - 4:30 PM');//so put the timings here
