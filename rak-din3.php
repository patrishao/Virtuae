        ...
        <div class="title-container">
            <div class="another-container1">
                <div class="title-slider"> <!-- images the one sa top left -->
                        <div><img src="images/RAK/Dine/Sanchaya/rakdin3B.jpg" class="picture" /></div>
                        <div><img src="images/RAK/Dine/Sanchaya/rakdin3C.jpg" class="picture" /></div>
                        <div><img src="images/RAK/Dine/Sanchaya/rakdin3F.jpg" class="picture" /></div>
                </div>
            </div>
            <div class="another-container">
                <h1 class="title1"> Sanchaya</h1> <!-- title -->
        ...
        <div class="info-hist-box" id="history">
         ...
         <div class="layer1">
            ...
            <h2 class="info-title"> Information </h2> <!-- images on the left -->
                <div class="img-set"><img src="images/RAK/Dine/Sanchaya/rakdin3D.jpg" class="smallimg" style="object-position: 0 -90px;"/></div>
                <div class="img-set"><img src="images/RAK/Dine/Sanchaya/rakdin3H.jpg" class="smallimg" style="object-position: 0 -90px;"/></div>
                <div class="img-set"><img src="images/RAK/Dine/Sanchaya/rakdin3A.jpg" class="smallimg" style="object-position: 0 -80px;"/></div>
            ...
            <div class="info-container">
                <div class="dl-bm">
                    ...
                    <a href="download/Ras Al Khaimah/Dine/Sanchaya.docx"> 
                    <button><img src="images/Desktop Download.png"/></button>
                    </a>
                    
                </div>
            <h2 class="info-title1"> Information </h2> <!-- description feel free to add per paragraph -->
                <p class="info-description">Sanchaya will offer Asian flavors with fresh ingredients and an infusion of spices to tackle your taste buds. 
                The restaurant offers great indoor ambiance and a large terrace with undisturbed views of the Arabian Gulf. They offer special diets that is 
                vegetarian friendly, hala, and give out vegan and gluten free options.
                    <br>
                    <br>

                    Sanchaya serves cuisines from Chinese, Japanese, Sushi, Asian, Thai.
...
<!-- -->
    ...
    <section id="media-wrappper">
        ...
        <div class="row row1">
            <div class="img-media"><img src="images/RAK/Dine/Sanchaya/rakdin3A.jpg" class="fiximg" />
            <p> One of their Main Courses</p>
            </div>

            <div class="img-media"><img src="images/RAK/Dine/Sanchaya/rakdin3B.jpg" class="fiximg" />
            <p> Indoor table near the windows </p>
            </div>

            <div class="img-media"><img src="images/RAK/Dine/Sanchaya/rakdin3C.jpg" class="fiximg" />
            <p> Outdoor tables </p>
            </div>

            <div class="img-media"><img src="images/RAK/Dine/Sanchaya/rakdin3D.jpg" class="fiximg" />
            <p> Covered Tables </p>
            </div>

            
            <div class="img-media"><img src="images/RAK/Dine/Sanchaya/rakdin3E.jpg" class="fiximg" />
            <p>  Restaurant's Bar </p>
            </div>
        ...
        <div class="img-media"><img src="images/RAK/Dine/Sanchaya/rakdin3F.jpg" class="fiximg" />
            <p>  One of their Main Courses </p>
            </div>

            <div class="img-media"><img src="images/RAK/Dine/Sanchaya/rakdin3G.jpg" class="fiximg" />
            <p>  One of their Main Courses </p>
            </div>

            <div class="img-media"><img src="images/RAK/Dine/Sanchaya/rakdin3H.jpg" class="fiximg" />
            <p> Semi-covered tables</p>
            </div>
