...
<head>
    ...
    <title>Malecon Restaurant</title>
...
<div id="navbar"> 
        ...
        <div class="title-container">
            <div class="another-container1">
                <div class="title-slider"> <!-- images the one sa top left -->
                        <div><img src="images/dubai/dxbdin2A.jpg" class="picture" /></div>
                        <div><img src="images/dubai/dine/dxbdin2E.jpg" class="picture" /></div>
                        <div><img src="images/dubai/dine/dxbdin2B.jpg" class="picture" /></div>
                </div>
            </div>
            <div class="another-container">
                <h1 class="title1"> Malecon Restaurant </h1> <!-- title -->
        ...
        <div class="info-hist-box" id="history">
         ...
         <div class="layer1">
            ...
            <h2 class="info-title"> Information </h2> <!-- images on the left -->
                <div class="img-set"><img src="images/dubai/dine/dxbdin2G.jpg"  style="object-position: 0 -50px;" class="smallimg"/></div>
                <div class="img-set"><img src="images/dubai/dine/IMG_2337.jpg"  style="object-position: 0 -50px;" class="smallimg"/></div>
                <div class="img-set"><img src="images/dubai/dine/dxbdin2F.jpg"  style="object-position: 0 -50px;" class="smallimg"/></div>
            </div>
            <div class="info-container">
                <div class="dl-bm">
                    ...
                    <a href="download/Dubai/Dine/Malecon Restaurant.docx"> 
    ...
    <iframe src="https://www.google.com/maps/embed?pb=!4v1622724220383!6m8!1m7!1sCAoSLEFGMVFpcE1nYU5YaW5CU091SldvVUpMVDhBdk93TnVMMVlscUVlbzBONWx5!2m2!1d25.234767248845!2d55.2623517438!3f17.403859389421648!4f7.476493910127488!5f0.4000000000000002" width="100%" height="1000px" style="border:none;" allowfullscreen="" loading="lazy"></iframe>
    <!-- google maps -->   
    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3609.064060133943!2d55.2623517438!3d25.234767248845!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3e5f4253305d8fbf%3A0xb264583138d524d6!2sMalecon%2C%20Latin%20American%20Restaurant%20%26%20Lounge!5e0!3m2!1sen!2sae!4v1622724268798!5m2!1sen!2sae"
...
<!-- -->
    ...
    <section id="media-wrappper">
        ...
        <div class="row row1">
            <div class="img-media"><img src="images/dubai/dine/IMG_2337.jpg"  class="fiximg" />
            <p> Food served in Malecon Restaurant </p>
            </div>

            <div class="img-media"><img src="images/dubai/dine/dxbdin2F.jpg"  class="fiximg" />
            <p> Food served in Malecon Restaurant </p>
            </div>

            <div class="img-media"><img src="images/dubai/dine/dxbdin2G.jpg"  class="fiximg" />
            <p> Interior Design of Malecon Restaurant </p>
            </div>

            <div class="img-media"><img src="images/dubai/dine/dxbdin2C.jpg"  class="fiximg" />
            <p> Singers </p>
            </div>

            <div class="img-media"><img src="images/dubai/dine/IMG_2338.jpg"  class="fiximg" />
            <p> Set up in Malecon Restaurant </p>
            </div>
    ...
    <script>
        ...
        function tues(){
            $('#timing-info').hide().fadeIn();
            $('#t-time').html( '12:00 PM to 1:00 AM' ); //so put the timings here
  
        }
        function wed(){
            $('#timing-info').hide().fadeIn();
            $('#t-time').html( '6:00 PM to 3:00 PM 6:00 PM to 3:00 AM' ); //so put the timings here
  
        }
        function thurs(){
            $('#timing-info').hide().fadeIn();
            $('#t-time').html(' 6:00 PM to 3:00 AM '); //so put the timings here
