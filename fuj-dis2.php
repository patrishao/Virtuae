        ...
        <div class="title-container">
            <div class="another-container1">
                <div class="title-slider"> <!-- images the one sa top left -->
                        <div><img src="images\fuj-pictures\Discover\Bitnah Fort\bitnahfort.JPG" class="picture" /></div>
                        <div><img src="images\fuj-pictures\Discover\Bitnah Fort\Screen_20Shot_202021-06-02_20at_2017.28.55.JPG" class="picture" /></div>
                </div>
            </div>
            <div class="another-container">
                <h1 class="title1"> BITHNAH FORT </h1> <!-- title -->
        ...
        <div class="info-hist-box" id="history">
         ...
         <div class="layer1">
            ...
            <h2 class="info-title"> Information </h2> <!-- images on the left -->
                <div class="img-set"><img src="images\fuj-pictures\Discover\Bitnah Fort\Screen_20Shot_202021-06-02_20at_2017.29.07.JPG" class="smallimg" style="object-position: 0 -200px;"/></div>
                <div class="img-set"><img src="images\fuj-pictures\Discover\Bitnah Fort\Screen_20Shot_202021-06-02_20at_2017.29.20.JPG" class="smallimg" style="object-position: 0 -100px;"/></div>
                <div class="img-set"><img src="images\fuj-pictures\Discover\Bitnah Fort\Screen_20Shot_202021-06-02_20at_2017.29.27.JPG" class="smallimg" style="object-position: 0 -300px;"/></div>
            </div>
            <div class="info-container">
                <div class="dl-bm">
                    ...
                    <a href="download\Fujairah\Discovery\Bithnah Fort.docx"> 
...
Prior to the construction of the road to Masafi in the 1970s, traffic through to the interior from the coast passed through the bed of the wadi, overlooked by the fort which would have occupied a strategic location – in fact, Bithnah through the ages has been a strategic holding and was a key mainstay in the fortunes of the Sharqiyin through the 18th and early 19th centuries.
                 ...
                 <h2 class="info-title"> History </h2>
                   ...
                   In 1884, Sheikh Hamad bin Abdullah Al Sharqi took Bithnah Fort, control of which was to be essential for him when, in 1901, he once again refused the suzerainty of Sharjah and used the fort at Bithnah to refuse aid to the headman of Kalba, who was related to Sheikh Saqr bin Khalid of Sharjah.This event sealed the de facto independence of Fujairah which was not, however, recognised by the British until 1952.
        ...
        <div class="blackbg">
        <img src="images\fuj-pictures\Discover\Bitnah Fort\Screen_20Shot_202021-06-02_20at_2017.30.33.JPG" class="wtd-bg"/> <!-- the bg for the entirety of the what to do part -->
        </div>
        <div class="scroller-area">
            ...
            <div class="contents-box">
                <div class="contents-img">
                    <img src="images\fuj-pictures\Discover\Bitnah Fort\Screen_20Shot_202021-06-02_20at_2017.29.20.JPG" />
                </div>
                <div class="contents-container">
                <h2 class="contents-title"> History </h2>
                <p class="contents-desc">It is one of the oldest forts found on the eastern coast of UAE. Al-Bitnah Fort is believed to be built in 1735.
            ...
            <div class="contents-box">
                <div class="contents-img">
                    <img src="images\fuj-pictures\Discover\Bitnah Fort\Screen_20Shot_202021-06-02_20at_2017.29.02.JPG" />
                </div>
                <div class="contents-container">
                <h2 class="contents-title"> Adventure </h2>
                <p class="contents-desc">Located mid way between Fujairah and Masafi, it is strategically positioned on ancient Wadi Ham trade routes through the Hajar Mountains. </p> <!-- put the actual activities here -->
                 </div>
            </div> 

            <div class="contents-box">
                <div class="contents-img">
                    <img src="images\fuj-pictures\Discover\Bitnah Fort\Screen_20Shot_202021-06-02_20at_2017.29.57.JPG" />
                </div>
                <div class="contents-container">
                <h2 class="contents-title"> Architecture </h2>
                <p class="contents-desc">The fort also has unknown megalithic tomb that is suggestive of the fort’s ancient age. </p> <!-- put the actual activities here -->
                 </div>
            </div> 
    ...
    <!-- to be replaced -->
    <!-- virtual tour -->
    <iframe width="100%" height="1000px" src="https://poly.google.com/view/79PdoGxGsVM/embed?chrome=min"  
     ...
     <!-- google maps -->   
     <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d57790.54809850673!2d56.302084050227066!3d25.138758566681044!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3ef4548e304c66fd%3A0xc2f23a4b72529c44!2zQWwtQml0aG5haCBGb3J0IC0g2YLZhNi52Kkg2KfZhNio2KvZhtip!5e0!3m2!1sen!2sae!4v1622840649288!5m2!1sen!2sae" width="100%" height="500" style="border:0;" allowfullscreen="" loading="lazy"></iframe>
    ...
    <section id="media-wrappper">
        ...
        <div class="row row1">
            <div class="img-media">
                <img src="images\fuj-pictures\Discover\Bitnah Fort\bitnahfort.JPG" class="fiximg" /> <!-- img! -->
                 <!-- description time, add smth like idk "fun time family!" -->
                <p> image of the fort and vegetation </p>
            </div>
            
            <div class="img-media">
                <img src="images\fuj-pictures\Discover\Bitnah Fort\Screen_20Shot_202021-06-02_20at_2017.28.55.JPG" class="fiximg" /> <!-- img! -->
                 <!-- description time, add smth like idk "fun time family!" -->
                <p> image of the fort and the sky  </p>
            </div>

            <div class="img-media">
                <img src="images\fuj-pictures\Discover\Bitnah Fort\Screen_20Shot_202021-06-02_20at_2017.29.02.JPG" class="fiximg" /> <!-- img! -->
                 <!-- description time, add smth like idk "fun time family!" -->
                <p> an area within the fort </p>
            </div>

            <div class="img-media">
                <img src="images\fuj-pictures\Discover\Bitnah Fort\Screen_20Shot_202021-06-02_20at_2017.29.27.JPG" class="fiximg" /> <!-- img! -->
                 <!-- description time, add smth like idk "fun time family!" -->
                <p>an enclosed entryway</p>
            </div>

            <div class="img-media">
                <img src="images\fuj-pictures\Discover\Bitnah Fort\Screen_20Shot_202021-06-02_20at_2017.29.07.JPG" class="fiximg" /> <!-- img! -->
                 <!-- description time, add smth like idk "fun time family!" -->
                <p> the mountains </p>
            </div>
        </div>
