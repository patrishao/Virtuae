...
<div id="navbar"> 
        ...
        <div class="title-container">
            <div class="another-container1">
                <div class="title-slider"> <!-- images the one sa top left -->
                        <div><img src="images/RAK/Dine/Zaitouna House/rakdin2E.jpg" class="picture" /></div>
                        <div><img src="images/RAK/Dine/Zaitouna House/rakdin2A.jpg" class="picture" /></div>
                        <div><img src="images/RAK/Dine/Zaitouna House/rakdin2G.jpg" class="picture" /></div>
                </div>
            </div>
            <div class="another-container">
                <h1 class="title1"> Zaitouna House </h1> <!-- title -->
        ...
        <div class="info-hist-box" id="history">
         ...
         <div class="layer1">
            ...
            <h2 class="info-title"> Information </h2> <!-- images on the left -->
                <div class="img-set"><img src="images/RAK/Dine/Zaitouna House/rakdin2H.jpg" class="smallimg"/></div>
                <div class="img-set"><img src="images/RAK/Dine/Zaitouna House/rakdin2C.jpg" class="smallimg"/></div>
                <div class="img-set"><img src="images/RAK/Dine/Zaitouna House/rakdin2F.jpg" class="smallimg"/></div>
            ...
            <div class="info-container">
                <div class="dl-bm">
                    ...
                    <a href="download/Ras Al Khaimah/Dine/Zaitouna House.docx"> 
                    <button><img src="images/Desktop Download.png"/></button>
                    </a>
                    
                </div>
            <h2 class="info-title1"> Information </h2> <!-- description feel free to add per paragraph -->
                <p class="info-description">With sweeping views of the Al Marjan waterfront, Zaitouna House serves up authentic Lebanese dishes and a sparkling al fresco setting. 
                Try the restaurant’s moreish mezze, perfect grills and delicious desserts, as well as our fresh catch of the day.

                    <br>
                    <br>

                    Located on the popular waterfront promenade, Zaitouna is the go-to venue for alfresco dining, trendy social gatherings, or an evening 
                    of island lounging while watching the gorgeous sunset. A popular choice for business and social gatherings, the restaurant provides curated 
                    menus that cater to various occasions and accommodate personal preferences.


                    <br>
                    <br>
                    
                    The restaurant serves traditional Levantine classics with a wide selection of grills, breads, salads and cold and hot mezze to choose from.
    ...
    <!-- google maps -->   
    <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d14382.370613904017!2d55.74279359636368!3d25.684794636360422!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0xd115cb57d8094a0d!2sZaitouna%20House!5e0!3m2!1sen!2sae!4v1622797282271!5m2!1sen!2sae" 
...
<!-- -->
    ...
    <section id="media-wrappper">
        ...
        <div class="row row1">
            <div class="img-media"><img src="images/RAK/Dine/Zaitouna House/rakdin2A.jpg" class="fiximg" />
            <p> Interior within Zaitouna House </p>
            </div>

            <div class="img-media"><img src="images/RAK/Dine/Zaitouna House/rakdin2B.jpg" class="fiximg" />
            <p> One of their Main Courses</p>
            </div>

            <div class="img-media"><img src="images/RAK/Dine/Zaitouna House/rakdin2C.jpg" class="fiximg" />
            <p> Main Course - Mixed Grill </p>
            </div>

            <div class="img-media"><img src="images/RAK/Dine/Zaitouna House/rakdin2D.jpg" class="fiximg" />
            <p> Main Course - Marinated Boneless half chicken </p>
            </div>

            <div class="img-media"><img src="images/RAK/Dine/Zaitouna House/rakdin2E.jpg" class="fiximg" />
            <p> Entrance to the Restaurant </p>
            </div>

        </div>
        <div class="row row2">
            <div class="img-media"><img src="images/RAK/Dine/Zaitouna House/rakdin2F.jpg" class="fiximg" />
            <p>  One of their Main Courses </p>
            </div>

            <div class="img-media"><img src="images/RAK/Dine/Zaitouna House/rakdin2G.jpg" class="fiximg" />
            <p> A selection of Hummus served in Zaitouna </p>
            </div>

            <div class="img-media"><img src="images/RAK/Dine/Zaitouna House/rakdin2H.jpg" class="fiximg" />
            <p> Table settings </p>
            </div>
    ...
    <script>
        ...
        function sun(){
            ...
            $('#t-time').html(' 12:30 PM - 11:00 PM '); //so put the timings here
