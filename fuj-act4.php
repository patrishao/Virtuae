...
<body>
        ...
        <div class="title-container">
            <div class="another-container1">
                <div class="title-slider"> <!-- images the one sa top left -->
                        <div><img src="images\fuj-pictures\Entertainment\Shark Island\0ww5m120006pwf7fm30ED.JPG" class="picture" /></div>
                        <div><img src="images\fuj-pictures\Entertainment\Shark Island\1_bJAlYpkVeu7JvbEYKOvDuQ.JPG" class="picture" /></div>
                </div>
            </div>
            <div class="another-container">
                <h1 class="title1"> SHARK ISLAND </h1> <!-- title -->
    ...
    <div class="wrapper2">
        <div class="info-hist-box" id="history">
         ...
         <div class="layer1">
            ...
            <h2 class="info-title"> Information </h2> <!-- images on the left -->
                <div class="img-set"><img src="images\fuj-pictures\Entertainment\Shark Island\b3c1e8dd2a0b1f9c43807df65fdee6ce.JPG" class="smallimg"/></div>
                <div class="img-set"><img src="images\fuj-pictures\Entertainment\Shark Island\Shark-Island-Khorfakkan-1-scaled.JPG" class="smallimg"/></div>
                <div class="img-set"><img src="images\fuj-pictures\Entertainment\Shark Island\b3c1e8dd2a0b1f9c43807df65fdee6ce.JPG" class="smallimg"/></div>
            </div>
            <div class="info-container">
                <div class="dl-bm">
                    ...
                    <a href="download\Fujairah\Activities\Shark Island.docx"> 
            ...
            <h2 class="info-title1"> Information </h2> <!-- description feel free to add per paragraph -->
                ...
                Off the coast of the Khorfakkan public beach, this small rocky island is an underwater marvel for everyone who enjoys snorkeling, scuba diving and swimming. Sea anemones and turtles are a treat for snorkelers, while divers flock here for the beautiful rock formations teeming with moray eels, rays and Arabian angelfish. If you prefer to stay on the surface, take a kayak out to spot schools of fish from above the clear waters.
                   ...
                   These rock formations are home to rays, moray eels and Arabian angelfish. If you spend hours marvelling at the work done by NatGeo, this would be your chance to live that experience. </p>                    
        ...
        <div class="blackbg">
        <img src="images\fuj-pictures\Entertainment\Shark Island\b3c1e8dd2a0b1f9c43807df65fdee6ce.JPG" class="wtd-bg"/> <!-- the bg for the entirety of the what to do part -->
        </div>
        <div class="scroller-area">
            ...
            <div class="contents-box">
                <div class="contents-img">
                    <img src="images\fuj-pictures\Entertainment\Shark Island\Shark-Island-Khorfakkan-1-scaled.JPG" />
                </div>
                <div class="contents-container">
                <h2 class="contents-title"> Diving </h2>
                <p class="contents-desc">As a family with children, choosing a nearby diving centre for guides to the island is highly recommended. You can easily rent equipment for a dive, or fins, snorkels and masks for snorkelling.
            ...
            <div class="contents-box">
                <div class="contents-img">
                    <img src="images\fuj-pictures\Entertainment\Shark Island\1_bJAlYpkVeu7JvbEYKOvDuQ.JPG" />
                </div>
                <div class="contents-container">
    ...
    <!-- to be replaced -->
    <!-- virtual tour -->
    <iframe width="100%" height="1000px" src="https://poly.google.com/view/cZ_BZxzrGxI/embed?chrome=min"  
    ...
    <section id="media-wrappper">
        ...
        <div class="row row1">
            <div class="img-media">
                <img src="images\fuj-pictures\Entertainment\Shark Island\0ww5m120006pwf7fm30ED.JPG" class="fiximg" /> <!-- img! -->
                 <!-- description time, add smth like idk "fun time family!" -->
                <p> rocks and the ocean </p>
            </div>
            
            <div class="img-media">
                <img src="images\fuj-pictures\Entertainment\Shark Island\1_bJAlYpkVeu7JvbEYKOvDuQ.JPG" class="fiximg" /> <!-- img! -->
                 <!-- description time, add smth like idk "fun time family!" -->
                <p> a boat near rocks </p>
            </div>

            <div class="img-media">
                <img src="images\fuj-pictures\Entertainment\Shark Island\1_S3V5-Oe2wGK0A-T8p6jAzw.JPG" class="fiximg" /> <!-- img! -->
                 <!-- description time, add smth like idk "fun time family!" -->
                <p> rocks </p>
            </div>

            <div class="img-media">
                <img src="images\fuj-pictures\Entertainment\Shark Island\b3c1e8dd2a0b1f9c43807df65fdee6ce.JPG" class="fiximg" /> <!-- img! -->
                 <!-- description time, add smth like idk "fun time family!" -->
                <p> top view, with a boat </p>
            </div>

            <div class="img-media">
                <img src="images\fuj-pictures\Entertainment\Shark Island\Shark-Island-Khorfakkan-1-scaled.JPG" class="fiximg" /> <!-- img! -->
                 <!-- description time, add smth like idk "fun time family!" -->
                <p> rocks with a person</p>
            </div>
        </div>
        <div class="row row2">
            <div class="img-media">
