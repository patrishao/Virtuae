...
<body>
        ...
        <div class="title-container">
            <div class="another-container1">
                <div class="title-slider"> <!-- images the one sa top left -->
                        <div><img src="images\fuj-pictures\Mosques\Al-Bidyah Mosque\Screen_20Shot_202021-06-02_20at_2016.32.29.JPG" class="picture" /></div>
                        <div><img src="images\fuj-pictures\Mosques\Al-Bidyah Mosque\Screen_20Shot_202021-06-02_20at_2016.31.59.JPG" class="picture" /></div>
                </div>
            </div>
            <div class="another-container">
                <h1 class="title1"> AL BIDYAH MOSQUE </h1> <!-- title -->
    ...
    <div class="wrapper2">
        <div class="info-hist-box" id="history">
         ...
         <div class="layer1">
            ...
            <h2 class="info-title"> Information </h2> <!-- images on the left -->
                <div class="img-set"><img src="images\fuj-pictures\Mosques\Al-Bidyah Mosque\Screen_20Shot_202021-06-02_20at_2016.31.17.JPG" class="smallimg" style="width:1000px;"/></div>
                <div class="img-set"><img src="images\fuj-pictures\Mosques\Al-Bidyah Mosque\Screen_20Shot_202021-06-02_20at_2016.32.55.JPG" class="smallimg"/></div>
                <div class="img-set"><img src="images\fuj-pictures\Mosques\Al-Bidyah Mosque\Screen_20Shot_202021-06-02_20at_2016.32.29.JPG" class="smallimg"/></div>
            </div>
            <div class="info-container">
                <div class="dl-bm">
                    ...
                    <a href="download\Fujairah\Mosque\Al Bidyah Mosque.docx"> 
        ...
        <div class="blackbg">
        <img src="images\fuj-pictures\Mosques\Al-Bidyah Mosque\Screen_20Shot_202021-06-02_20at_2016.31.43.JPG" class="wtd-bg"/> <!-- the bg for the entirety of the what to do part -->
        </div>
        <div class="scroller-area">
            ...
            <div class="contents-box">
                ...
                <p class="contents-desc">The mosque is held in great significance because it's the oldest mosque in the UAE which is still functioning uninterruptedly to this day. </p> <!-- put the actual activities here -->
                 </div>
            </div> 
            ...
            <div class="contents-box">
                ...
                <p class="contents-desc">The mosque is a very small building with four domes centrally supported by one-pillar. It can accommodate no more than 20 people at a given time. </p> <!-- put the actual activities here -->
                 </div>
            </div> 
    ...
    <section id="media-wrappper">
        ...
        <div class="row row1">
            <div class="img-media">
                <img src="images\fuj-pictures\Mosques\Al-Bidyah Mosque\albidyah.JPG" class="fiximg" /> <!-- img! -->
                 <!-- description time, add smth like idk "fun time family!" -->
                <p> an entrance </p>
            </div>
            
            <div class="img-media">
                <img src="images\fuj-pictures\Mosques\Al-Bidyah Mosque\Screen_20Shot_202021-06-02_20at_2016.31.17.JPG" class="fiximg" /> <!-- img! -->
                 <!-- description time, add smth like idk "fun time family!" -->
                <p> a scenic view </p>
            </div>

            <div class="img-media">
                <img src="images\fuj-pictures\Mosques\Al-Bidyah Mosque\Screen_20Shot_202021-06-02_20at_2016.31.43.JPG" class="fiximg" /> <!-- img! -->
                 <!-- description time, add smth like idk "fun time family!" -->
                <p> another view of the mosque </p>
            </div>

            <div class="img-media">
                <img src="images\fuj-pictures\Mosques\Al-Bidyah Mosque\Screen_20Shot_202021-06-02_20at_2016.31.59.JPG" class="fiximg" /> <!-- img! -->
                 <!-- description time, add smth like idk "fun time family!" -->
                <p>a tree and some people</p>
            </div>

            <div class="img-media">
                <img src="images\fuj-pictures\Mosques\Al-Bidyah Mosque\Screen_20Shot_202021-06-02_20at_2016.32.29.JPG" class="fiximg" /> <!-- img! -->
                 <!-- description time, add smth like idk "fun time family!" -->
                <p> a top view</p>
            </div>
        </div>
        <div class="row row2">
            <div class="img-media">
                <img src="images\fuj-pictures\Mosques\Al-Bidyah Mosque\Screen_20Shot_202021-06-02_20at_2016.32.55.JPG" class="fiximg" /> <!-- img! -->
                 <!-- description time, add smth like idk "fun time family!" -->
                <p> the roof </p>
            </div>
