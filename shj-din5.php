...
<div id="navbar"> 
        ...
        <div class="title-container">
            <div class="another-container1">
                <div class="title-slider"> <!-- images the one sa top left -->
                        <div><img src="images\shj-pictures\Dine\Gazebo Restaurant\shjdin5C.JPG" class="picture" /></div>
                        <div><img src="images\shj-pictures\Dine\Gazebo Restaurant\shjdin5G.JPG" class="picture" /></div>
                        <div><img src="images\shj-pictures\Dine\Gazebo Restaurant\shjdin5E.JPG" class="picture" /></div>
                </div>
            </div>
            <div class="another-container">
                <h1 class="title1">Gazebo Restaurant</h1> <!-- title -->
        ...
        <div class="info-hist-box" id="history">
         ...
         <div class="layer1">
            ...
            <h2 class="info-title"> Information </h2> <!-- images on the left -->
                <div class="img-set"><img src="images\shj-pictures\Dine\Gazebo Restaurant\shjdin5A.JPG" class="smallimg"/></div>
                <div class="img-set"><img src="images\shj-pictures\Dine\Gazebo Restaurant\shjdin5E.JPG" class="smallimg"/></div>
                <div class="img-set"><img src="images\shj-pictures\Dine\Gazebo Restaurant\shjdin5D.JPG" class="smallimg"/></div>
            </div>
            <div class="info-container">
                <div class="dl-bm">
                    ...
                    <a href="download\Sharjah\Dine\Gazebo Restaurant.docx"> 
                    <button><img src="images/Desktop Download.png"/></button>
                    </a>
                    
                </div>
                <h2 class="info-title1"> Information </h2> <!-- description feel free to add per paragraph -->
                <p class="info-description"> Enjoy a world of artistic wonder and creativity‎ spread over large spacious galleries that welcome you throughout 
                the year. This unique museum offers art lovers and all visitors, the opportunity to admire the splendor of a variety of collections and 
                temporary exhibitions hosted by the museum, and also participate in the museum’s regular program and workshops.

                    <br>
                    <br>

                    A new building of the museum was established on April 7, 1997, under the patronage of Sheikh Sultan bin Muhammad Al-Qasimi, the Supreme Council 
                    Member and Ruler of Sharjah during the 3rd Sharjah International Arts Biennial. Sharjah Art Museum has a collection of modern and contemporary 
                    art by artists from United Arab Emirates and other Middle Eastern countries. It also organizes and hosts temporary exhibitions and educational 
                    events. It has a total floor area of 111,000 m² with galleries over two floors and an underground car park beneath it."Established in the year 
                    2000, the pioneers of 'Dum Pukht' biryani in the UAE, Gazebo is acclaimed for exquisite Indian cuisine, authentically prepared using age-old recipes 
                    from the Mughal era. Taking unabashed pride in the presence of chefs, who are descendants of the 'khansamas' from the Mughal kitchens, not only 
                    does Gazebo do justice to every culinary masterpiece, but also retains the authenticity of the amazing delicacies recreated, using 200-year-old 
                    recipes. Over the past 2 decades, Gazebo has perfected the ‘Dum Pukht’ style of cooking; where food is cooked on low flame, trapping all the natural 
                    flavours inside, resulting in fragrantly delicious dishes. With an impressively extensive menu, there's something to satisfy every gourmand."
    ...
    <!-- google maps -->   
    <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d14424.549649801382!2d55.3927088!3d25.3331696!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0xba03760a93ab0d85!2sGazebo%20Restaurant!5e0!3m2!1sen!2sae!4v1622915886486!5m2!1sen!2sae"
...
<!-- -->
    ...
    <section id="media-wrappper">
        ...
        <div class="row row1">
            <div class="img-media"><img src="images\shj-pictures\Dine\Gazebo Restaurant\shjdin5A.JPG" class="fiximg" />
            <p> Food in Gazebo Restaurant </p>
            </div>

            <div class="img-media"><img src="images\shj-pictures\Dine\Gazebo Restaurant\shjdin5B.JPG" class="fiximg" />
            <p> Food in Gazebo Restaurant </p>
            </div>

            <div class="img-media"><img src="images\shj-pictures\Dine\Gazebo Restaurant\shjdin5C.JPG" class="fiximg" />
            <p> Outside view of Gazebo Restaurant </p>
            </div>

            <div class="img-media"><img src="images\shj-pictures\Dine\Gazebo Restaurant\shjdin5D.JPG" class="fiximg" />
            <p> Food in Gazebo Restaurant </p>
            </div>

            <div class="img-media"><img src="images\shj-pictures\Dine\Gazebo Restaurant\shjdin5E.JPG" class="fiximg" />
            <p> Food in Gazebo Restaurant </p>
            </div>

        </div>
        <div class="row row2">
        <div class="img-media"><img src="images\shj-pictures\Dine\Gazebo Restaurant\shjdin5F.JPG" class="fiximg" />
        <p> Food in Gazebo Restaurant </p>
            </div>

            <div class="img-media"><img src="images\shj-pictures\Dine\Gazebo Restaurant\shjdin5G.JPG" class="fiximg" />
            <p> Seating inside the restaurant </p>
            </div>

            <div class="img-media"><img src="images\shj-pictures\Dine\Gazebo Restaurant\shjdin5H.JPG" class="fiximg" />
            <p> Food in Gazebo Restaurant </p>
            </div>
    ...
    <script>
        ...
        function sun(){
            ...
            $('#t-time').html(' 05:00 PM - 01:00 AM '); //so put the timings here
