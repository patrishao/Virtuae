...
<div id="navbar"> 
        ...
        <div class="title-container">
            <div class="another-container1">
                <div class="title-slider"> <!-- images the one sa top left -->
                        <div><img src="images/dubai/dxbdin5D.jpg" class="picture" /></div>
                        <div><img src="images/dubai/dine/dxbdin5E.jpg" class="picture" /></div>
                        <div><img src="images/dubai/dine/IMG_2366.jpg" class="picture" /></div>
                </div>
            </div>
            <div class="another-container">
                <h1 class="title1"> Catch22 </h1> <!-- title -->
        ...
        <div class="info-hist-box" id="history">
         ...
         <div class="layer1">
            ...
            <h2 class="info-title"> Information </h2> <!-- images on the left -->
                <div class="img-set"><img src="images/dubai/dine/IMG_2370.jpg" style="object-position: 0 -50px;" class="smallimg"/></div>
                <div class="img-set"><img src="images/dubai/dine/dxbdin5C.jpg" style="object-position: 0 -50px;" class="smallimg"/></div>
                <div class="img-set"><img src="images/dubai/dine/dxbdin5H.jpg" style="object-position: 0 -50px;" class="smallimg"/></div>
            </div>
            <div class="info-container">
                <div class="dl-bm">
                    ...
                    <a href="download/Dubai/Dine/Catch22.docx"> 
    ...
    <iframe src="https://www.google.com/maps/embed?pb=!4v1622729637451!6m8!1m7!1sCAoSLEFGMVFpcE1TLVkwUFZ6Slc0akZsVjNrMWxXeXY0M3RQRmw2Vnd5dGJ0Tjl5!2m2!1d25.0768358!2d55.13152789999999!3f260!4f10!5f0.7820865974627469" width="100%" height="1000px" style="border:none;" allowfullscreen="" loading="lazy"></iframe>
    <!-- google maps -->   
    <iframe src=https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d115639.64621279239!2d55.13152789999999!3d25.0768358!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3e5f14a9f2d95be3%3A0x745b77b9bfc17d9f!2sCatch22!5e0!3m2!1sen!2sae!4v1622729672836!5m2!1sen!2sae"
...
<!-- -->
    ...
    <section id="media-wrappper">
        ...
        <div class="row row1">
            <div class="img-media"><img src="images/dubai/dine/dxbdin5C.jpg"  class="fiximg" />
            <p> Food served in Catch22 </p>
            </div>

            <div class="img-media"><img src="images/dubai/dine/dxbdin5E.jpg"  class="fiximg" />
            <p> Food served in Catch22 </p>
            </div>

            <div class="img-media"><img src="images/dubai/dxbdin5D.jpg"  class="fiximg" />
            <p> Food served in Catch22  </p>
            </div>

            <div class="img-media"><img src="images/dubai/dine/IMG_2370.jpg"  class="fiximg" />
            <p> Food served in Catch22 </p>
            </div>

            <div class="img-media"><img src="images/dubai/dine/dxbdin5H.jpg"  class="fiximg" />
            <p> Food served in Catch22 </p>
            </div>
    ...
    <script>
        ...
        function sun(){
            ...
            $('#t-time').html( '8:00 AM to 1:00 AM' ); //so put the timings here
