...
<head>
    ...
    <title> Sharjah Desert Park </title>
...
<body>
        ...
        <div class="title-container">
            <div class="another-container1">
                <div class="title-slider"> <!-- images the one sa top left -->
                        <div><img src="images\shj-pictures\Activities\Sharjah Desert Park\shjact3A.JPG" class="picture" /></div>
                        <div><img src="images\shj-pictures\Activities\Sharjah Desert Park\shjact3D.JPG" class="picture" /></div>
                        <div><img src="images\shj-pictures\Activities\Sharjah Desert Park\shjact3F.JPG" class="picture" /></div>
                </div>
            </div>
            <div class="another-container">
                <h1 class="title1"> Sharjah Desert Park </h1> <!-- title -->
    ...
    <div class="wrapper2">
        <div class="info-hist-box" id="history">
         ...
         <div class="layer1">
            ...
            <h2 class="info-title"> Information </h2> <!-- images on the left -->
                <div class="img-set"><img src="images\shj-pictures\Activities\Sharjah Desert Park\shjact3D.JPG" class="smallimg"/></div>
                <div class="img-set"><img src="images\shj-pictures\Activities\Sharjah Desert Park\shjact3C.JPG" class="smallimg"/></div>
                <div class="img-set"><img src="images\shj-pictures\Activities\Sharjah Desert Park\shjact3H.JPG" class="smallimg"/></div>
            </div>
            <div class="info-container">
                <div class="dl-bm">
                    ...
                    <a href="download\Sharjah\Activities\Sharjah Desert Park.docx"> 
            ...
            <h2 class="info-title1"> Information </h2> <!-- description feel free to add per paragraph -->
                ...
                For wildlife enthusiasts, families and travelers alike, this Sharjah wildlife centre should top 
                the list of places to visit in Sharjah.

                    <br> 
                    <br>

                    Inside, you will find four major venues. Arabia’s Wildlife Centre houses the Arabian leopard, 
                    the oryx and other rare animals for up close viewing. The Natural History Museum and Botanical 
                    Garden, one of the most important parks in Sharjah for ecotourism, offers a wealth of knowledge 
                    about the flora and fauna in the Arabian Peninsula.

                    <br> 
                    <br>

                    For things to do with kids, visit the petting zoo, where the whole family can spend some time 
                    with furry farm animals. The park also has the Breeding Centre for Endangered Arabian Wildlife, 
                    which promotes the survival of species nearing extinction.
                   ...
                   Established in 1995 in the Seih Al-Masmout Reserve, this desert park in Sharjah started as a 
                   conservation centre for the region’s endangered flora and fauna. 
                    </p>                    
        ...
        <div class="blackbg">
        <img src="images\shj-pictures\Activities\Sharjah Desert Park\shjact3F.JPG" class="wtd-bg"/> <!-- the bg for the entirety of the what to do part -->
        </div>
        <div class="scroller-area">
            ...
            <div class="contents-box">
                ...
                Walk among flora and fauna in a specialized nature reserve for endangered desert species.
                Call ahead of your visit to find out about special viewings, events and summer activities for kids.
                </p>
                </div>
            </div> 
            ...
            <div class="contents-box">
                ...
                <img src="images\shj-pictures\Activities\Sharjah Desert Park\shjact3D.JPG"/> <!-- the bg for the entirety of the what to do part -->
                </div>
                <div class="contents-container">
                <h2 class="contents-title"> Learning </h2>
                <p class="contents-desc"> 
                 Inside, you will find four major venues. Arabia’s Wildlife Centre houses the Arabian leopard, the oryx and 
                 other rare animals for up close viewing. 
                </p> 
                </div>
            </div> 
            ...
            <div class="contents-box">
                <div class="contents-img">
                <img src="images\shj-pictures\Activities\Sharjah Desert Park\shjact3H.JPG"/> <!-- the bg for the entirety of the what to do part -->
                </div>
                <div class="contents-container">
                <h2 class="contents-title"> Science </h2>
                <p class="contents-desc">
                It helps its visitors to get a better understanding of the flora and fauna of U.A.E as well as scientific 
                explanation of natural processes in the most fun way possible.
                </p> 
                 </div>
            </div> 
    ...
    <!-- to be replaced -->
    <!-- virtual tour -->
    <iframe width="100%" height="1000px" src="https://poly.google.com/view/8C9UeFMASlV/embed?chrome=min" 
     ...
     <!-- google maps -->   
    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d461789.6059044734!2d55.41582903281252!3d25.27962299999999!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3ef592ebeed25ec3%3A0x4c67cc76d42a2f9c!2z2YXZhtiq2LLZhyDYp9mE2LXYrdix2KfYoSBEZXNlcnQgUGFyaw!5e0!3m2!1sen!2sae!4v1622847269087!5m2!1sen!2sae"
    ...
    <section id="media-wrappper">
        ...
        <div class="row row1">
            <div class="img-media">
            <img src="images\shj-pictures\Activities\Sharjah Desert Park\shjact3A.JPG" class="fiximg" /> <!-- img! -->
            <p> Establishment of Sharjah Desert Park </p>
            </div>
            
            <div class="img-media">
            <img src="images\shj-pictures\Activities\Sharjah Desert Park\shjact3B.JPG" class="fiximg" /> <!-- img! -->
            <p> Tiger over the grassy plane </p>
            </div>

            <div class="img-media">
            <img src="images\shj-pictures\Activities\Sharjah Desert Park\shjact3C.JPG" class="fiximg" /> <!-- img! -->
            <p> Greenhouse within the building </p>
            </div>

            <div class="img-media">
            <img src="images\shj-pictures\Activities\Sharjah Desert Park\shjact3D.JPG" class="fiximg" /> <!-- img! -->
            <p> Child feeding an animal </p>
            </div>

            <div class="img-media">
            <img src="images\shj-pictures\Activities\Sharjah Desert Park\shjact3E.JPG" class="fiximg" /> <!-- img! -->
            <p> Path within Sharjah Desert Park </p>
            </div>
        </div>
        <div class="row row2">
            <div class="img-media">
            <img src="images\shj-pictures\Activities\Sharjah Desert Park\shjact3F.JPG" class="fiximg" /> <!-- img! -->
            <p> Desert dunes </p>
            </div>

            <div class="img-media">
            <img src="images\shj-pictures\Activities\Sharjah Desert Park\shjact3G.JPG" class="fiximg" /> <!-- img! -->
            <p> Outside view of the Greenhouse </p>
            </div>
            
            <div class="img-media">
            <img src="images\shj-pictures\Activities\Sharjah Desert Park\shjact3H.JPG" class="fiximg" /> <!-- img! -->
            <p> Exhibits within the Sharjah Desert Park </p>
            </div>
