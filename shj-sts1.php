...
<head>
    ...
    <title>Martyrs Square and Monument</title>
...
<body>
    ...
    <div class="wrapper1">
        <div class="title-container">
            ...
            <div class="another-container">
                <h1 class="title1"> MARTYRS SQUARE AND MONUMENT </h1> <!-- title -->
    ...
    <div class="wrapper2">
        <div class="info-hist-box" id="history">
         ...
         <div class="layer1">
            ...
            <h2 class="info-title"> Information </h2> <!-- images on the left -->
                <div class="img-set"><img src="images\shj-pictures\Sights to See\Martyrs Square and Monument\shjsts1B.JPG" class="smallimg" style="width:1000px;"/></div>
                <div class="img-set"><img src="images\shj-pictures\Sights to See\Martyrs Square and Monument\shjsts1D.JPG" class="smallimg"/></div>
                <div class="img-set"><img src="images\shj-pictures\Sights to See\Martyrs Square and Monument\shjsts1E.JPG" class="smallimg"/></div>
            </div>
            <div class="info-container">
                <div class="dl-bm">
                    ...
                    <a href="download\Sharjah\Sights to See\Martyrs Square and Monument.docx"> 
            ...
            <h2 class="info-title1"> Information </h2> <!-- description feel free to add per paragraph -->
                ...
                Establishing the Martyrs Square, which was built by members of the armed forces, in accordance with the directives of His Highness Sheikh Dr. Sultan bin Mohammed Al Qasimi, Member of the Supreme Council and Ruler of Sharjah, to commemorate our brave martyrs who presented the most beautiful images of sacrifice and redemption for the sake of the nation’s rise and protect its security and stability.
                    <br> 
                    <br>
                 </p>
        ...
        <div class="blackbg">
        <img src="images\shj-pictures\Sights to See\Martyrs Square and Monument\shjsts1F.JPG" class="wtd-bg"/> <!-- the bg for the entirety of the what to do part -->
        </div>
        <div class="scroller-area">
            ...
            <div class="contents-box">
                ...
                <p class="contents-desc1">All who live on this holy land enjoy security and peace.</p>
                 </div>
            </div> 
            
            <div class="contents-box">
                <div class="contents-img">
                    <img src="images\shj-pictures\Sights to See\Martyrs Square and Monument\shjsts1E.JPG" />
                </div>
                <div class="contents-container">
                <h2 class="contents-title"> Observe </h2>
                <p class="contents-desc"> Take a moment to appreciate the wonderful architecture of this momument. </p> <!-- put the actual activities here -->
                 </div>
            </div> 
            
            <div class="contents-box">
                <div class="contents-img">
                    <img src="images\shj-pictures\Sights to See\Martyrs Square and Monument\shjsts1D.JPG" />
                </div>
                <div class="contents-container">
                <h2 class="contents-title"> Admire </h2>
                <p class="contents-desc"> This monument has a rich history, respect and learn about the people this monument was built for. </p> <!-- put the actual activities here -->
                 </div>
            </div> 
    ...
    <!-- to be replaced -->
    <!-- virtual tour -->
    <iframe width="100%" height="1000px" src="https://poly.google.com/view/cufkZ_HnNdv/embed?chrome=min" frameborder="0" style="border:none;" allowvr="yes" allow="vr; xr; accelerometer; magnetometer; gyroscope; autoplay;" allowfullscreen mozallowfullscreen="true" webkitallowfullscreen="true" onmousewheel="" ></iframe>
     <!-- google maps -->   
     <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d57723.37724440577!2d55.42659737910158!3d25.28030290000001!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3e5f5fa35aae2c81%3A0x4e92b891af9071f2!2sMartyrs%20Monument!5e0!3m2!1sen!2sae!4v1622925985708!5m2!1sen!2sae" width="100%" height="500" style="border:0;" allowfullscreen="" loading="lazy"></iframe>
    ...
    <section id="media-wrappper">
        ...
        <div class="row row1">
            <div class="img-media">
                <img src="images\shj-pictures\Sights to See\Martyrs Square and Monument\shjsts1A.JPG" class="fiximg" /> <!-- img! -->
                 <!-- description time, add smth like idk "fun time family!" -->
                <p> intimidating view of the monument </p>
            </div>
            
            <div class="img-media">
                <img src="images\shj-pictures\Sights to See\Martyrs Square and Monument\shjsts1B.JPG" class="fiximg" /> <!-- img! -->
                 <!-- description time, add smth like idk "fun time family!" -->
                <p> a view of the horizon </p>
            </div>
        ...
        <div class="row row2">
            <div class="img-media">
                <img src="images\shj-pictures\Sights to See\Martyrs Square and Monument\shjsts1F.JPG" class="fiximg" /> <!-- img! -->
                 <!-- description time, add smth like idk "fun time family!" -->
                <p> a lively picture at night </p>
            </div>
