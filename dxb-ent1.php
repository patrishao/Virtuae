...
<div id="navbar"> 
        ...
        <div class="title-container">
            <div class="another-container1">
                <div class="title-slider"> <!-- images the one sa top left -->
                        <div><img src="images/dubai/Dubai-Opera-House.JPG" class="picture" /></div>
                        <div><img src="images/dubai/entertainment/opera2.JPG" class="picture" /></div>
                        <div><img src="images/dubai/entertainment/opera5.JPG" class="picture" /></div>
                </div>
            </div>
            <div class="another-container">
                <h1 class="title1"> Dubai Opera </h1> <!-- title -->
    ...
    <div class="wrapper2">
        <div class="info-hist-box" id="history">
         ...
         <div class="layer1">
            ...
            <h2 class="info-title"> Information </h2> <!-- images on the left -->
                <div class="img-set"><img src="images/dubai/entertainment/opera6.JPG" style="object-position: 0 -50px;" class="smallimg"/></div>
                <div class="img-set"><img src="images/dubai/entertainment/opera1.JPG" style="object-position: 0 -50px;" class="smallimg"/></div>
                <div class="img-set"><img src="images/dubai/entertainment/opera5.JPG" style="object-position: 0 -50px;" class="smallimg"/></div>
            </div>
            <div class="info-container">
                <div class="dl-bm">
                    ...
                    <a href="download/Dubai/Entertainment/Dubai Opera.docx"> 
        ...
        <div class="blackbg">
        <img src="images/dubai/entertainment/opera2.JPG" class="wtd-bg"/> <!-- the bg for the entirety of the what to do part -->
        </div>
        <div class="scroller-area">
            ...
            <div class="contents-box">
                ...
                <p class="contents-desc1">Dubai Opera is the city's first purpose-built multi-format performing arts theatre and the definitive destination for quality entertainment productions</p>
                 </div>
            </div> 
            
            <div class="contents-box">
                <div class="contents-img">
                    <img src="images/dubai/entertainment/opera4.JPG"/>
                </div>
                <div class="contents-container">
                <h2 class="contents-title"> Shows </h2>
                <p class="contents-desc">
                It’s a tremendous venue that brings the best performers in classical, pop, rock and theatre to the UAE.</p> <!-- put the actual activities here -->
                 </div>
            </div> 
            <div class="contents-box">
                <div class="contents-img">
                    <img src="images/dubai/entertainment/opera3.JPG"/>
                </div>
                <div class="contents-container">
                <h2 class="contents-title"> Dine </h2>
                <p class="contents-desc">
                The Loft at Dubai Opera is a laid back venue beautifully located at the top of the most iconic architectural building in the UAE, the Dubai Opera.</p> <!-- put the actual activities here -->
                 </div>
            </div> 
    ...
    <iframe src="https://www.google.com/maps/embed?pb=!4v1622713976476!6m8!1m7!1sCAoSLEFGMVFpcE00RS1xNFdvTFdIOUpESlo0eUY3RkNIS0pXcFpKbEppQ0Vac29O!2m2!1d25.195617!2d55.271879!3f43.10611975613703!4f9.090647337162252!5f0.7820865974627469" width="100%" height="1000px" style="border:none;" allowfullscreen="" loading="lazy"></iframe>

    <!-- google maps -->   
    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3610.225493640244!2d55.26969031508724!3d25.19561698389704!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3e5f682aaf28d991%3A0xc855ffaf3a4aff63!2sDubai%20Opera!5e0!3m2!1sen!2sae!4v1622713903829!5m2!1sen!2sae"
...
<!-- -->
    ...
    <section id="media-wrappper">
        ...
        <div class="row row1">
            <div class="img-media"><img src="images/dubai/entertainment/opera4.JPG" class="fiximg" />
            <p> People watching the show at Dubai Opera </p>
            </div>

            <div class="img-media"><img src="images/dubai/entertainment/opera5.JPG" class="fiximg" />
            <p> Dubai Opera House </p>
            </div>

            <div class="img-media"><img src="images/dubai/entertainment/opera2.JPG" class="fiximg" />
            <p> Performance at the Dubai Opera </p>
            </div>

            <div class="img-media"><img src="images/dubai/entertainment/opera6.JPG" class="fiximg" />
            <p> Preparations for the show </p>
            </div>

            <div class="img-media"><img src="images/dubai/Dubai-Opera-House.JPG" class="fiximg" />
            <p> Dubai Opera House </p>
            </div>  
        </div>
    ...
    <script>
        ...
        function sun(){
            ...
            $('#t-time').html(' 10:00 AM to 9:00 PM '); //so put the timings here
