...
<head>
    ...
    <title>Al Farooq Omar Bin Al Khattab Mosque</title>
...
<div id="navbar"> 
        ...
        <div class="title-container">
            <div class="another-container1">
                <div class="title-slider"> <!-- images the one sa top left -->
                        <div><img src="images/dubai/alfarooq.JPG" class="picture" /></div>
                        <div><img src="images/dubai/mosque/farooq2.JPG" class="picture" /></div>
                        <div><img src="images/dubai/mosque/farooq5.JPG" class="picture" /></div>
                </div>
            </div>
            <div class="another-container">
                <h1 class="title1"> Al Farooq Omar Bin Al Khattab Mosque </h1> <!-- title -->
    ...
    <div class="wrapper2">
        <div class="info-hist-box" id="history">
         ...
         <div class="layer1">
            ...
            <h2 class="info-title"> Information </h2> <!-- images on the left -->
                <div class="img-set"><img src="images/dubai/mosque/farooq4.JPG" style="object-position: 0 -50px;" class="smallimg"/></div>
                <div class="img-set"><img src="images/dubai/mosque/farooq6.JPG" style="object-position: 0 -50px;" class="smallimg"/></div>
                <div class="img-set"><img src="images/dubai/mosque/farooq5.JPG" style="object-position: 0 -50px;" class="smallimg"/></div>
            </div>
            <div class="info-container">
                <div class="dl-bm">
                    ...
                    <a href="download/Dubai/Mosque/Al Farooq Omar Bin Al Khattab Mosque – Umm Suqeim.docx"> 
                    <button><img src="images/Desktop Download.png"/></button>
                    </a>
                    
                </div>
            <h2 class="info-title1"> Information </h2> <!-- description feel free to add per paragraph -->
                <p class="info-description">The Al Farooq Omar Bin Al Khattab Mosque and Centre is one of the first mosques to open their doors to non-Muslims. Whether you want to discover the faith of Islam, admire stunning architecture, or stop by to pray, this stunning mosque is a hub for peace and harmony. Not only does the mosque and centre bridge Arabic civilization with the rest of the world, it is also a stunning piece of architecture in the heart of Al Safa. 
                ...
                The Al Farooq Omar Bin Al Khattab Mosque is a mosque located in Dubai, United Arab Emirates. The mosque is named after Umar bin Al Khattab, a companion of the Prophet Mohammed who became the second Caliph after Abu Bakr and was given the title Al Farooq, meaning someone who distinguished truth from falsehood.
        ...
        <div class="blackbg">
        <img src="images/dubai/mosque/farooq2.JPG" class="wtd-bg"/> <!-- the bg for the entirety of the what to do part -->
        </div>
        <div class="scroller-area">
            ...
            <div class="contents-box">
                ...
                <p class="contents-desc1">Al Farooq Omar Bin Al Khattab Mosque & Centre is a Mecca for tourists and foreigners, a tourist landmark, and an Islamic and cultural centre.</p>
                 </div>
            </div> 
            
            <div class="contents-box">
                <div class="contents-img">
                    <img src="images/dubai/mosque/farooq3.JPG"/>
                </div>
                <div class="contents-container">
                <h2 class="contents-title"> Tour </h2>
                <p class="contents-desc">
                Al Farooq Omar Bin Al Khattab Mosque & Centre is a Mecca for tourists and foreigners, a tourist landmark, and an Islamic and cultural centre where large groups of tourists race to visit and take tours therein.</p> <!-- put the actual activities here -->
                 </div>
            </div> 

            <div class="contents-box">
                <div class="contents-img">
                    <img src="images/dubai/mosque/farooq4.JPG"/>
                </div>
                <div class="contents-container">
                <h2 class="contents-title"> Learn </h2>
                <p class="contents-desc">
                Mosques are very important in Islam. Having arrived and settled in Medina, the Messenger of Allah (peace be upon him) was keen to establish a well-organized and deep-rooted Muslim community composing of all Muslims.</p> <!-- put the actual activities here -->
                 </div>
            </div> 
        </div>
        </div>
    ...
    <iframe src="https://www.google.com/maps/embed?pb=!4v1622852102235!6m8!1m7!1sCAoSLEFGMVFpcFBXN3ZFWnp0NTJ3TXdtcFZpTGJTZ2hqblNPQjNuUmNqVjNvT01Q!2m2!1d25.1717041!2d55.23299859999999!3f30.972964292458578!4f1.2321152422716608!5f0.4000000000000002" width="100%" height="1000px" style="border:0;" allowfullscreen="" loading="lazy"></iframe>
    <!-- google maps -->   
    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3610.934065141116!2d55.23299859999999!3d25.1717041!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3e5f69f116b57dd9%3A0x7c2a85286ee7cab6!2sAlFarooq%20Omar%20Bin%20AlKhattab%20Mosque!5e0!3m2!1sen!2sae!4v1622852126278!5m2!1sen!2sae"
...
<!-- -->
    ...
    <section id="media-wrappper">
        ...
        <div class="row row1">
            <div class="img-media"><img src="images/dubai/mosque/farooq1.jpg" class="fiximg" />
            <p> Al Farooq Omar Bin Al Khattab Mosque </p>
            </div>

            <div class="img-media"><img src="images/dubai/mosque/farooq2.JPG" class="fiximg" />
            <p> Al Farooq Omar Bin Al Khattab Mosque </p>
            </div>

            <div class="img-media"><img src="images/dubai/mosque/farooq3.jpg" class="fiximg" />
            <p> Al Farooq Omar Bin Al Khattab Mosque </p>
            </div>

            <div class="img-media"><img src="images/dubai/mosque/farooq4.JPG" class="fiximg" />
            <p> Al Farooq Omar Bin Al Khattab Mosque</p>
            </div>

            <div class="img-media"><img src="images/dubai/mosque/farooq5.jpg" class="fiximg" />
            <p> Al Farooq Omar Bin Al Khattab Mosque </p>
            </div>
    ...
    <script>
        ...
        function sun(){
            ...
            $('#t-time').html(' 10:00 AM to 8:00 PM '); //so put the timings here

        }
        function mon(){
            $('#timing-info').hide().fadeIn();
            $('#t-time').html(' 10:00 AM to 11:00 AM 4:15 PM to 6:PM'); //so put the timings here
