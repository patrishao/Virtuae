...
<head>
    ...
    <title>Sharjah Municipality Building</title>
...
<body>
        ...
        <div class="title-container">
            <div class="another-container1">
                <div class="title-slider"> <!-- images the one sa top left -->
                        <div><img src="images\shj-pictures\Sights to See\Martyrs Square and Monument\shjsts1A.JPG" class="picture" /></div>
                        <div><img src="images\shj-pictures\Sights to See\Martyrs Square and Monument\shjsts1F.JPG" class="picture" /></div>
                </div>
            </div>
            <div class="another-container">
                <h1 class="title1"> SHARJAH MUNICIPALITY BUILDING </h1> <!-- title -->
    ...
    <div class="wrapper2">
        <div class="info-hist-box" id="history">
         ...
         <div class="layer1">
            ...
            <h2 class="info-title"> Information </h2> <!-- images on the left -->
                <div class="img-set"><img src="images\shj-pictures\Sights to See\Sharjah Municipality Building\shjsts3A.JPG" class="smallimg" style="width:1000px;"/></div>
                <div class="img-set"><img src="images\shj-pictures\Sights to See\Sharjah Municipality Building\shjsts3B.JPG" class="smallimg"/></div>
                <div class="img-set"><img src="images\shj-pictures\Sights to See\Sharjah Municipality Building\shjsts3C.JPG" class="smallimg"/></div>
            </div>
            <div class="info-container">
                <div class="dl-bm">
                    ...
                    <a href="download\Sharjah\Sights to See\Sharjah Municipality Building.docx"> 
            ...
            <h2 class="info-title1"> Information </h2> <!-- description feel free to add per paragraph -->
                ...
                Sharjah Municipality is responsible for planning and providing the requirements of transport, roads & traffic in the Emirate of Sharjah, and between Sharjah and other Emirates of the UAE, neighboring countries in order to provide an effective & an integrated transport system capable of achieving Sharjah's vision & serving the vital interests of the Emirate.
        ...
        <div class="blackbg">
        <img src="images\shj-pictures\Sights to See\Sharjah Municipality Building\shjsts3D.JPG" class="wtd-bg"/> <!-- the bg for the entirety of the what to do part -->
        </div>
        <div class="scroller-area">
            ...
            <div class="contents-box">
                ...
                <p class="contents-desc1">The Sharjah Municipality was founded in 1927 and was given its complete powers in 1971. </p>
                 </div>
            </div> 
            ...
            <div class="contents-box">
                ...
                <p class="contents-desc"> Take a moment to appreciate the wonderful architecture of this building. </p> <!-- put the actual activities here -->
                 </div>
            </div> 
            
            <div class="contents-box">
                <div class="contents-img">
                    <img src="images\shj-pictures\Sights to See\Sharjah Municipality Building\shjsts3F.JPG" />
                </div>
                <div class="contents-container">
                <h2 class="contents-title"> Appreciate </h2>
                <p class="contents-desc"> The Sharjah Municipality offers a wide range of services that oversee the entire functioning of the emirate. </p> <!-- put the actual activities here -->
                 </div>
            </div> 
    ...
    <!-- to be replaced -->
    <!-- virtual tour -->
    <iframe width="100%" height="1000px" src="https://poly.google.com/view/aQHW9xt4gSh/embed?chrome=min" frameborder="0" style="border:none;" allowvr="yes" allow="vr; xr; accelerometer; magnetometer; gyroscope; autoplay;" allowfullscreen mozallowfullscreen="true" webkitallowfullscreen="true" onmousewheel="" ></iframe>
     <!-- google maps -->   
     <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d115408.90805525535!2d55.476226703324706!3d25.32004492705472!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x4223dbf662abeec5!2sSharjah%20Municipality%20-%20Main%20Office!5e0!3m2!1sen!2sae!4v1622933175345!5m2!1sen!2sae" width="100%" height="500" style="border:0;" allowfullscreen="" loading="lazy"></iframe>
    ...
    <section id="media-wrappper">
        ...
        <div class="row row1">
            <div class="img-media">
                <img src="images\shj-pictures\Sights to See\Sharjah Municipality Building\shjsts3A.JPG" class="fiximg" /> <!-- img! -->
                 <!-- description time, add smth like idk "fun time family!" -->
                <p> picture of the top part of the municipality building </p>
            </div>
            
            <div class="img-media">
                <img src="images\shj-pictures\Sights to See\Sharjah Municipality Building\shjsts3B.JPG" class="fiximg" /> <!-- img! -->
                 <!-- description time, add smth like idk "fun time family!" -->
                <p> dramatic lighting on the building </p>
            </div>

            <div class="img-media">
                <img src="images\shj-pictures\Sights to See\Sharjah Municipality Building\shjsts3C.JPG" class="fiximg" /> <!-- img! -->
                 <!-- description time, add smth like idk "fun time family!" -->
                <p> daytime with the flag being raised </p>
            </div>

            <div class="img-media">
                <img src="images\shj-pictures\Sights to See\Sharjah Municipality Building\shjsts3D.JPG" class="fiximg" /> <!-- img! -->
                 <!-- description time, add smth like idk "fun time family!" -->
                <p> more dramatic lighting </p>
            </div>

            <div class="img-media">
                <img src="images\shj-pictures\Sights to See\Martyrs Square and Monument\shjsts1E.JPG" class="fiximg" /> <!-- img! -->
                 <!-- description time, add smth like idk "fun time family!" -->
                <p> a monument on the sunset </p>
            </div>
        </div>
        <div class="row row2">
            <div class="img-media">
                <img src="images\shj-pictures\Sights to See\Sharjah Municipality Building\shjsts3E.JPG" class="fiximg" /> <!-- img! -->
                 <!-- description time, add smth like idk "fun time family!" -->
                <p> broad daylight at the municipality building </p>
            </div>
