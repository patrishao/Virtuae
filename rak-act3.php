...
<div id="navbar"> 
        ...
        <div class="title-container">
            <div class="another-container1">
                <div class="title-slider"> <!-- images the one sa top left -->
                        <div><img src="images/RAK/Activities/Iceland Waterpark/rakent5C.jpg" class="picture" /></div>
                        <div><img src="images/RAK/Activities/Iceland Waterpark/rakent5E.jpg" class="picture" /></div>
                        <div><img src="images/RAK/Activities/Iceland Waterpark/rakent5H.jpg" class="picture" /></div>
                </div>
            </div>
            <div class="another-container">
                <h1 class="title1"> Iceland Waterpark </h1> <!-- title -->
    ...
    <div class="wrapper2">
        <div class="info-hist-box" id="history">
         ...
         <div class="layer1">
            ...
            <h2 class="info-title"> Information </h2> <!-- images on the left -->
                <div class="img-set"><img src="images/RAK/Activities/Iceland Waterpark/rakent5F.jpg" class="smallimg"/></div>
                <div class="img-set"><img src="images/RAK/Activities/Iceland Waterpark/rakent5B.jpg" class="smallimg"/></div>
                <div class="img-set"><img src="images/RAK/Activities/Iceland Waterpark/rakent5G.jpg" class="smallimg"/></div>
            </div>
            <div class="info-container">
                <div class="dl-bm">
                    ...
                    <a href="download/Ras Al Khaimah/Activities/Iceland Waterpark.docx"> 
                    <button><img src="images/Desktop Download.png"/></button>
                    </a>
                    
                </div>
            <h2 class="info-title1"> Information </h2> <!-- description feel free to add per paragraph -->
                <p class="info-description">The UAE’s largest waterpark and is located in Ras Al Khaimah – only an hours’ drive from Dubai.
                     Ice Land has more than 30 exciting slides, a huge wave pool, high end- private cabanas, an Olympic sized lap pool and a beautiful beach. 
                     With its dedicated kids pools and areas suitable for children, it has something for everyone. Ice Land also specializes in offering team building activities
                     for the corporate sector. Ice Land Water Park has a dedicated events team to plan and cater for other private functions, birthday parties and special events.


                    <br>
                    <br>

                    Iceland Waterpark is just another example of the wonders that Dubai is creating for all. This waterpark has practical experience in offering group building exercises for the corporate part.
                    The most recent expansion to the park is the new beach front campground.
        ...
        <div class="blackbg">
        <img src="images/RAK/Activities/Iceland Waterpark/rakent5H.jpg" class="wtd-bg"/> <!-- the bg for the entirety of the what to do part -->
        </div>
        <div class="scroller-area">
            ...
            <div class="contents-box">
                ...
                <p class="contents-desc1"> Iceland Waterpark has more than 30 thrilling slides, a colossal wave pool, and a top of the line private cabanas.
                    It offers a lot of activities for everybody.
                </p>
                 </div>
            </div> 
            ...
            <div class="contents-box">
                <div class="contents-img">
                    <img src="images/RAK/Activities/Iceland Waterpark/rakent5B.jpg" />
                </div>
                <div class="contents-container">
                <h2 class="contents-title"> Amusement Rides </h2>
                <p class="contents-desc"> <br>
                  Iceland is unique water park with extensive theming in snow and ice offering a mix of traditional water park attractions.
            ...
            <div class="contents-box">
                <div class="contents-img">
                <img src="images/RAK/Activities/Iceland Waterpark/rakent5A.jpg" />
                </div>
                <div class="contents-container">
                <h2 class="contents-title"> Slides </h2>
                <p class="contents-desc"> Ice land offer some remarkable attractions with the Penguin Falls, World's Largest Man made
                     Waterfall, and Rocky Polar Mountains, along with the biggest arrangement of waterslides.</p> <!-- put the actual activities here -->
                 </div>
            </div> 
    ...
    <iframe width="100%" height="1000px" src="https://poly.google.com/view/bc-9zaEHhPU/embed?chrome=min" frameborder="0" style="border:none;" allowvr="yes" 
    ...
    <br>
     <!-- google maps -->   
     <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1797.3381200509687!2d55.82065331535444!3d25.715141442516984!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3ef60b1e130a7455%3A0xef6ab1549479af1a!2sIce%20Land%20Water%20Park!5e0!3m2!1sen!2sae!4v1622743970498!5m2!1sen!2sae" 
...
<!-- -->
    ...
    <section id="media-wrappper">
        ...
        <div class="row row1">
            <div class="img-media">
            <img src="images/RAK/Activities/Iceland Waterpark/rakent5A.jpg" class="fiximg" />
            <p> Waterpak Slides </p>
            </div>
            
            <div class="img-media"><img src="images/RAK/Activities/Iceland Waterpark/rakent5B.jpg" class="fiximg" />
            <p> People swimming in the waterpark</p>
            </div>

            <div class="img-media"><img src="images/RAK/Activities/Iceland Waterpark/rakent5C.jpg" class="fiximg" />
            <p> Entrance of Ice Land</p>
            </div>

            <div class="img-media"><img src="images/RAK/Activities/Iceland Waterpark/rakent5D.jpg" class="fiximg" />
            <p>Visitors enjoying the activities</p>
            </div>
            
            <div class="img-media"><img src="images/RAK/Activities/Iceland Waterpark/rakent5E.jpg" class="fiximg" />
            <p> Dining Area of the waterpark</p>
            </div>
        
        </div>

        <div class="row row2">
            <div class="img-media"><img src="images/RAK/Activities/Iceland Waterpark/rakent5F.jpg" class="fiximg" />
            <p> The snow river</p>
            </div>

            <div class="img-media"><img src="images/RAK/Activities/Iceland Waterpark/rakent5G.jpg" class="fiximg" />
            <p> Amusement Rides in the waterpark</p>
            </div>

            <div class="img-media"><img src="images/RAK/Activities/Iceland Waterpark/rakent5H.jpg" class="fiximg" />
            <p> The penguin bay </p>
            </div>

            <div class="img-media">
            <img src="images/RAK/Activities/Iceland Waterpark/rakent5A.jpg" class="fiximg" class="fiximg" />
            <p> Waterpak Slides </p>
            </div>
    ...
    <script>
        ...
        function sun(){
            ...
            $('#t-time').html(' 10:00 AM to 06:00 PM '); //so put the timings here
