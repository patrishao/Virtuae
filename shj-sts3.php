...
<body>
        ...
        <div class="title-container">
            <div class="another-container1">
                <div class="title-slider"> <!-- images the one sa top left -->
                        <div><img src="images\shj-pictures\Sights to See\Al Rafisah Dam\shjsts4A.JPG" class="picture" /></div>
                        <div><img src="images\shj-pictures\Sights to See\Al Rafisah Dam\shjsts4B.JPG" class="picture" /></div>
                </div>
            </div>
            <div class="another-container">
                <h1 class="title1"> AL RAFISAH DAM </h1> <!-- title -->
    ...
    <div class="wrapper2">
        <div class="info-hist-box" id="history">
         ...
         <div class="layer1">
            ...
            <h2 class="info-title"> Information </h2> <!-- images on the left -->
                <div class="img-set"><img src="images\shj-pictures\Sights to See\Al Rafisah Dam\shjsts4C.JPG" class="smallimg"/></div>
                <div class="img-set"><img src="images\shj-pictures\Sights to See\Al Rafisah Dam\shjsts4D.JPG" class="smallimg"/></div>
                <div class="img-set"><img src="images\shj-pictures\Sights to See\Al Rafisah Dam\shjsts4E.JPG" class="smallimg" style="width:1000px"/></div>
            </div>
            <div class="info-container">
                <div class="dl-bm">
                    ...
                    <a href="download\Sharjah\Sights to See\Al Rafisah Dam.docx"> 
            ...
            <h2 class="info-title1"> Information </h2> <!-- description feel free to add per paragraph -->
                ...
                Travel time from Sharjah to Khorfakkan has been reduced to 45 minutes, due to the new road, allowing more visitors to enjoy the serene pleasures of the area where a large, clear lake with boating facilities is overlooked by the magnificent Hajar mountains. The scenery is unmatched with the sandstone mountain range looming over a pure azure reservoir with its accompanying tranquil green landscape and man-made waterfall, perfect for nature lovers and outdoors enthusiasts.
                 ...
                 <h2 class="info-title"> History </h2>
                   ...
                   Heading toward Khorfakkan on the new Sharjah – Khorfakkan highway opens up a vista of the beautiful Al Rafisah Dam. Originally built in the 1980s, the dam has had an upgrade with a new visitor centre and rest area.
                    </p>                     
        ...
        <div class="blackbg">
        <img src="images\shj-pictures\Sights to See\Al Rafisah Dam\shjsts4E.JPG" class="wtd-bg"/> <!-- the bg for the entirety of the what to do part -->
        </div>
        <div class="scroller-area">
            ...
            <div class="contents-box">
                ...
                <p class="contents-desc1">The dam is an area rich in local flora and fauna, including the Little Grebe and other migrating and wintering birds, as well as being home to problematic introduced and invasive species, such as Tilapia and the red-eared slider turtle.</p>
                 </div>
            </div> 
            
            <div class="contents-box">
                <div class="contents-img">
                    <img src="images\shj-pictures\Sights to See\Al Rafisah Dam\shjsts4F.JPG" />
                </div>
                <div class="contents-container">
                <h2 class="contents-title"> Relax </h2>
                <p class="contents-desc"> There is a rest area, a mosque, outdoor play areas for children, a parking lot and supermarket as well as a popular restaurant with a lake view.
            ...
            <div class="contents-box">
                <div class="contents-img">
                    <img src="images\shj-pictures\Sights to See\Al Rafisah Dam\shjsts4G.JPG" />
                </div>
                <div class="contents-container">
                <h2 class="contents-title"> Play </h2>
                <p class="contents-desc"> The dam has a nice play zone area dedicated to kids. Get to try out your paddle boating skills in the beautiful nature.</p> <!-- put the actual activities here -->
                 </div>
            </div> 
            
            <div class="contents-box">
                <div class="contents-img">
                    <img src="images\shj-pictures\Sights to See\Al Rafisah Dam\shjsts4H.JPG" />
                </div>
                <div class="contents-container">
                <h2 class="contents-title"> Scenery </h2>
                <p class="contents-desc"> The scenery makes for a perfect location to take amazing photos for your Instagram’s bragging rights. It’s a perfect venue for the whole family to enjoy a peaceful weekend. </p> <!-- put the actual activities here -->
                 </div>
            </div> 
    ...
    <!-- to be replaced -->
    <!-- virtual tour -->
    <iframe width="100%" height="1000px" src="https://poly.google.com/view/82bZZUjeogZ/embed?chrome=min" frameborder="0" style="border:none;" allowvr="yes" allow="vr; xr; accelerometer; magnetometer; gyroscope; autoplay;" allowfullscreen mozallowfullscreen="true" webkitallowfullscreen="true" onmousewheel="" ></iframe>
     <!-- google maps -->   
     <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3605.6695968370623!2d56.30904851538285!3d25.34886583175017!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3ef44e8bf49118a1%3A0x96445ef2ea933652!2sAl%20Rafisah%20Dam!5e0!3m2!1sen!2sae!4v1622931845037!5m2!1sen!2sae" width="100%" height="500" style="border:0;" allowfullscreen="" loading="lazy"></iframe>
    ...
    <section id="media-wrappper">
        ...
        <div class="row row1">
            <div class="img-media">
                <img src="images\shj-pictures\Sights to See\Al Rafisah Dam\shjsts4A.JPG" class="fiximg" /> <!-- img! -->
                 <!-- description time, add smth like idk "fun time family!" -->
                <p> scenic view of the dam </p>
            </div>
            
            <div class="img-media">
                <img src="images\shj-pictures\Sights to See\Al Rafisah Dam\shjsts4B.JPG" class="fiximg" /> <!-- img! -->
                 <!-- description time, add smth like idk "fun time family!" -->
                <p> along a walking area with lights and railings </p>
            </div>

            <div class="img-media">
                <img src="images\shj-pictures\Sights to See\Al Rafisah Dam\shjsts4C.JPG" class="fiximg" /> <!-- img! -->
                 <!-- description time, add smth like idk "fun time family!" -->
                <p> pictures of boats at the dam </p>
            </div>

            <div class="img-media">
                <img src="images\shj-pictures\Sights to See\Al Rafisah Dam\shjsts4D.JPG" class="fiximg" /> <!-- img! -->
                 <!-- description time, add smth like idk "fun time family!" -->
                <p> boat docking </p>
            </div>

            <div class="img-media">
                <img src="images\shj-pictures\Sights to See\Al Rafisah Dam\shjsts4E.JPG" class="fiximg" /> <!-- img! -->
                 <!-- description time, add smth like idk "fun time family!" -->
                <p> another picture at the docks </p>
            </div>
        </div>
        <div class="row row2">
            <div class="img-media">
                <img src="images\shj-pictures\Sights to See\Al Rafisah Dam\shjsts4F.JPG" class="fiximg" /> <!-- img! -->
                 <!-- description time, add smth like idk "fun time family!" -->
                <p> picture of the dam with flowers </p>
            </div>

            <div class="img-media">
                <img src="images\shj-pictures\Sights to See\Al Rafisah Dam\shjsts4G.JPG" class="fiximg" /> <!-- img! -->
                 <!-- description time, add smth like idk "fun time family!" -->
                <p> the view from an elevated area </p>
            </div>
