...
<body>
        ...
        <div class="title-container">
            <div class="another-container1">
                <div class="title-slider"> <!-- images the one sa top left -->
                        <div><img src="images\auh-pictures\Dine\Cipriani\auhdin2A.jpg" class="picture" /></div>
                        <div><img src="images\auh-pictures\Dine\Cipriani\auhdin2F.jpg" class="picture" /></div>
                        <div><img src="images\auh-pictures\Dine\Cipriani\auhdin2G.jpg" class="picture" /></div>
                </div>
            </div>
            <div class="another-container">
                <h1 class="title1"> CIPRIANI </h1> <!-- title -->
    ...
    <div class="wrapper2">
        ...
        <div class="layer1">
            ...
            <h2 class="info-title"> Information </h2> <!-- images on the left -->
                ...
                <div class="img-set"><img src="images\auh-pictures\Dine\Cipriani\auhdin2B.jpg" class="smallimg"/></div>
                <div class="img-set"><img src="images\auh-pictures\Dine\Cipriani\auhdin2C.jpg" class="smallimg"/></div>
                <div class="img-set"><img src="images\auh-pictures\Dine\Cipriani\auhdin2H.jpg" class="smallimg"/></div>
            ...
            <div class="info-container">
                ...
                <div class="dl-bm">
                    ...
                    <a href="download\Abu Dhabi\Dine\Cipriani.docx"> 
            ...
            <h2 class="info-title1"> Information </h2> <!-- description feel free to add per paragraph -->
                ...
                <p class="info-description"> 
                    ...
                    Available all year around, Cipriani Yas Island’s à la carte menu menu is built on the concept of simple 
                    Italian food made to perfection and was inspired by the story of Giuseppe Cipriani Sr. Appealing to many 
                    different tastes, the Venetian and classic Italian dishes use seasonal, premium ingredients and produce, 
                    all of which are flown in directly from Italian farms, adding real authenticity to the menu.

                    <br><br>

                    The cuisine encompasses signature items from the original Harry’s Bar, including risotto primavera, baked 
                    tagliolini and vanilla crème meringue. Cipriani is also well known for inventing famous dishes like the 
                    Carpaccio alla Cipriani, which was invented by Giuseppe Cipriani Sr. in 1950, and the Bellini cocktail, 
                    created in 1948.
    ...
    <!-- google maps -->   
    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3631.52705184349!2d54.609042!3d24.4671889!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3e5e4589fe813ef7%3A0x32ee7be185f8ccd3!2sCipriani!5e0!3m2!1sen!2sae!4v1622737585706!5m2!1sen!2sae"
    ...
    <section id="media-wrappper">
        ...
        <div class="row row1">
            <div class="img-media">
                <img src="images\auh-pictures\Dine\Cipriani\auhdin2A.jpg" class="fiximg" /> <!-- img! -->
                 <!-- description time, add smth like idk "fun time family!" -->
                <p> A night view of Yas Viceroy from the outdoor dining area </p>
            </div>
            
            <div class="img-media">
                <img src="images\auh-pictures\Dine\Cipriani\auhdin2E.jpg" class="fiximg" /> <!-- img! -->
                 <!-- description time, add smth like idk "fun time family!" -->
                <p> Cipriani's bar </p>
            </div>

            <div class="img-media">
                <img src="images\auh-pictures\Dine\Cipriani\auhdin2C.jpg" class="fiximg" /> <!-- img! -->
                 <!-- description time, add smth like idk "fun time family!" -->
                <p> Cipriani Vanilla Meringue Cake </p>
            </div>

            <div class="img-media">
                <img src="images\auh-pictures\Dine\Cipriani\auhdin2D.jpg" class="fiximg" /> <!-- img! -->
                 <!-- description time, add smth like idk "fun time family!" -->
                <p> A different view of Yas Viceroy from the dining area </p>
            </div>

            <div class="img-media">
                <img src="images\auh-pictures\Dine\Cipriani\auhdin2B.jpg" class="fiximg" /> <!-- img! -->
                 <!-- description time, add smth like idk "fun time family!" -->
                <p> Carpaccio and bread from Cipriani </p>
            </div>
        </div>
        
        <div class="row row2">
            <div class="img-media">
                <img src="images\auh-pictures\Dine\Cipriani\auhdin2F.jpg" class="fiximg" /> <!-- img! -->
                 <!-- description time, add smth like idk "fun time family!" -->
                <p> Dining area </p>
            </div>

            <div class="img-media">
                <img src="images\auh-pictures\Dine\Cipriani\auhdin2G.jpg" class="fiximg" /> <!-- img! -->
                 <!-- description time, add smth like idk "fun time family!" -->
                <p> Lounge area </p>
            </div>
            
            <div class="img-media">
                <img src="images\auh-pictures\Dine\Cipriani\auhdin2H.jpg" class="fiximg" /> <!-- img! -->
                 <!-- description time, add smth like idk "fun time family!" -->
                <p> Morning view of Yas Viceroy </p>
            </div>
    ...
    <script>
        ...
        function sun(){
            ...
            $('#t-time').html('6:00 PM to 12:00 AM'); //so put the timings here
