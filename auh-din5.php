...
<head>
    ...
    <title>The Terrace On The Corniche</title>
...
<body>
        ...
        <div class="title-container">
            <div class="another-container1">
                <div class="title-slider"> <!-- images the one sa top left -->
                        <div><img src="images\auh-pictures\Dine\The Terrace on the Corniche\auhdin5A.jpg" class="picture" /></div>
                        <div><img src="images\auh-pictures\Dine\The Terrace on the Corniche\auhdin5B.jpg" class="picture" /></div>
                        <div><img src="images\auh-pictures\Dine\The Terrace on the Corniche\auhdin5C.jpg" class="picture" /></div>
                </div>
            </div>
            <div class="another-container">
                <h1 class="title1"> THE TERRACE ON THE CORNICHE </h1> <!-- title -->
    ...
    <div class="wrapper2">
        ...
        <div class="layer1">
            ...
            <h2 class="info-title"> Information </h2> <!-- images on the left -->
                ...
                <div class="img-set"><img src="images\auh-pictures\Dine\The Terrace on the Corniche\auhdin5D.jpg" class="smallimg"/></div>
                <div class="img-set"><img src="images\auh-pictures\Dine\The Terrace on the Corniche\auhdin5H.jpg" class="smallimg"/></div>
                <div class="img-set"><img src="images\auh-pictures\Dine\The Terrace on the Corniche\auhdin5F.jpg" class="smallimg"/></div>
            ...
            <div class="info-container">
                ...
                <div class="dl-bm">
                    ...
                    <a href="download\Abu Dhabi\Dine\The Terrace On The Corniche.docx"> 
            ...
            <h2 class="info-title1"> Information </h2> <!-- description feel free to add per paragraph -->
                ...
                <p class="info-description"> 
                    ...
                    Delight in a vast array of culinary stations, savour the finest flavours from the region and 
                    experience a fresh perspective on international cuisine. Located on the ground level at The St. 
                    Regis Abu Dhabi, a highlight of this vibrant dining destination is the indoor-outdoor flow. 
                    Guests can choose to dine in the richly coloured main dining room or al fresco at the enchanting 
                    garden terrace and bar, which also enjoys private access from the Abu Dhabi Corniche.
    ...
    <section id="media-wrappper">
        ...
        <div class="row row1">
            <div class="img-media">
                <img src="images\auh-pictures\Dine\The Terrace on the Corniche\auhdin5A.jpg" class="fiximg" /> <!-- img! -->
                 <!-- description time, add smth like idk "fun time family!" -->
                <p> The Terrace on the Corniche </p>
            </div>
            
            <div class="img-media">
                <img src="images\auh-pictures\Dine\The Terrace on the Corniche\auhdin5B.jpg" class="fiximg" /> <!-- img! -->
                 <!-- description time, add smth like idk "fun time family!" -->
                <p> A variety of cuisines </p>
            </div>

            <div class="img-media">
                <img src="images\auh-pictures\Dine\The Terrace on the Corniche\auhdin5C.jpg" class="fiximg" /> <!-- img! -->
                 <!-- description time, add smth like idk "fun time family!" -->
                <p> The dessert station </p>
            </div>

            <div class="img-media">
                <img src="images\auh-pictures\Dine\The Terrace on the Corniche\auhdin5D.jpg" class="fiximg" /> <!-- img! -->
                 <!-- description time, add smth like idk "fun time family!" -->
                <p> International dining </p>
            </div>

            <div class="img-media">
                <img src="images\auh-pictures\Dine\The Terrace on the Corniche\auhdin5E.jpg" class="fiximg" /> <!-- img! -->
                 <!-- description time, add smth like idk "fun time family!" -->
                <p> An example of what the buffet food looks like </p>
            </div>
        </div>
        
        <div class="row row2">
            <div class="img-media">
                <img src="images\auh-pictures\Dine\The Terrace on the Corniche\auhdin5F.jpg" class="fiximg" /> <!-- img! -->
                 <!-- description time, add smth like idk "fun time family!" -->
                <p> Breakfast at The Terrace on the Corniche </p>
            </div>

            <div class="img-media">
                <img src="images\auh-pictures\Dine\The Terrace on the Corniche\auhdin5G.jpg" class="fiximg" /> <!-- img! -->
                 <!-- description time, add smth like idk "fun time family!" -->
                <p> A chocolate fountain with assorted fruits and sweets </p>
            </div>
            
            <div class="img-media">
                <img src="images\auh-pictures\Dine\The Terrace on the Corniche\auhdin5H.jpg" class="fiximg" /> <!-- img! -->
                 <!-- description time, add smth like idk "fun time family!" -->
                <p> Seafood at The Terrace on the Corniche </p>
            </div>
    ...
    <script>
        ...
        function sun(){
            ...
            $('#t-time').html('7:00 AM to 11:00 AM'); //so put the timings here
        ...
        function thurs(){
            $('#timing-info').hide().fadeIn();
            $('#t-time').html('7:00 AM to 11:00 AM, 7:00 PM to 11:00 PM');//so put the timings here
            
        }
        function fri(){
            $('#timing-info').hide().fadeIn();
            $('#t-time').html('7:00 AM to 12:00 PM, 7:00 PM to 11:00 PM');//so put the timings here

        }
        function sat(){
            $('#timing-info').hide().fadeIn();
            $('#t-time').html('7:00 AM to 12:00 PM');//so put the timings here
