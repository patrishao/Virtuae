...
<head>
    ...
    <title>Dubai Festival City</title>
...
<div id="navbar"> 
        ...
        <div class="title-container">
            <div class="another-container1">
                <div class="title-slider"> <!-- images the one sa top left -->
                        <div><img src="images/dubai/Dubai-Festival-City-Mall-1-1.JPG" class="picture" /></div>
                        <div><img src="images/dubai/entertainment/dfc4.JPG" class="picture" /></div>
                        <div><img src="images/dubai/entertainment/dfc2.JPG" class="picture" /></div>
                </div>
            </div>
            <div class="another-container">
                <h1 class="title1"> Dubai Festival City </h1> <!-- title -->
    ...
    <div class="wrapper2">
         ...
         <div class="layer1">
            ...
            <div class="info-container">
                <div class="dl-bm">
                    ...
                    <a href="download/Dubai/Entertainment/Dubai Festival City Mall.docx"> 
        ...
        <div class="blackbg">
        <img src="images/dubai/Dubai-Festival-City-Mall-1-1.JPG" class="wtd-bg"/> <!-- the bg for the entirety of the what to do part -->
        </div>
        <div class="scroller-area">
            ...
            <div class="contents-box">
                ...
                <p class="contents-desc1">A modern business and entertainment area, Dubai Festival City centers on a massive mall of the same name, home to international fashion and furniture brands, global food courts and a cinema complex.</p>
                 </div>
            </div> 
            
            <div class="contents-box">
                <div class="contents-img">
                    <img src="images/dubai/entertainment/dfc6.JPG"/>
                </div>
                <div class="contents-container">
                <h2 class="contents-title"> IMAGINE </h2>
                <p class="contents-desc">
                IMAGINE offers up a unique sensory experience. With 30 fountains and surround sound to connect with audiences, IMAGINE is a show like never seen before.</p> <!-- put the actual activities here -->
                 </div>
            </div> 
            
            <div class="contents-box">
                <div class="contents-img">
                    <img src="images/dubai/entertainment/dfc3.JPG" />
                </div>
                <div class="contents-container">
                <h2 class="contents-title"> Rides </h2>
                <p class="contents-desc">Immerse yourself in the rich tradition and history of the dhow boats while cruising down the scenic creek. Take a cruise in Dubai and experience first-hand some of the most beautiful vistas Dubai has to offer.
...
<!-- -->
    ...
    <section id="media-wrappper">
        ...
        <div class="row row1">
            <div class="img-media"><img src="images/dubai/entertainment/dfc7.JPG" class="fiximg" />
            <p> IKEA at DFC</p>
            </div>

            <div class="img-media"><img src="images/dubai/entertainment/dfc2.JPG" class="fiximg" />
            <p> Shop at Dubai Festival City </p>
            </div>

            <div class="img-media"><img src="images/dubai/Dubai-Festival-City-Mall-1-1.JPG" class="fiximg" />
            <p> Dubai Festival City Mall </p>
            </div>

            <div class="img-media"><img src="images/dubai/entertainment/dfc6.JPG" class="fiximg" />
            <p> Enjoy the fireworks at DFC </p>
            </div>

            <div class="img-media"><img src="images/dubai/entertainment/dfc5.JPG" class="fiximg" />
            <p> Dine at DFC </p>
            </div>
