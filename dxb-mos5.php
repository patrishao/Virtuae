...
<head>
    ...
    <title>Khalifa Al Tajer Mosque</title>
...
<div id="navbar"> 
        ...
        <div class="title-container">
            <div class="another-container1">
                <div class="title-slider"> <!-- images the one sa top left -->
                        <div><img src="images/dubai/mkhalifa.JPG" class="picture" /></div>
                        <div><img src="images/dubai/mosque/khalif2.JPG" class="picture" /></div>
                        <div><img src="images/dubai/mosque/khalif3.JPG" class="picture" /></div>
                </div>
            </div>
            <div class="another-container">
                <h1 class="title1"> Khalifa Al Tajer Mosque </h1> <!-- title -->
    ...
    <div class="wrapper2">
        <div class="info-hist-box" id="history">
         ...
         <div class="layer1">
            ...
            <h2 class="info-title"> Information </h2> <!-- images on the left -->
                <div class="img-set"><img src="images/dubai/mosque/khalif1.JPG" style="object-position: 0 -50px;" class="smallimg"/></div>
                <div class="img-set"><img src="images/dubai/mosque/khalif6.JPG" style="object-position: 0 -50px;" class="smallimg"/></div>
                <div class="img-set"><img src="images/dubai/mosque/khalif5.JPG" style="object-position: 0 -50px;" class="smallimg"/></div>
            </div>
            <div class="info-container">
                <div class="dl-bm">
                    ...
                    <a href="download/Dubai/Mosque/Khalifa Al Tajer Mosque.docx"> 
                    <button><img src="images/Desktop Download.png"/></button>
                    </a>
                    
                </div>
            <h2 class="info-title1"> Information </h2> <!-- description feel free to add per paragraph -->
                <p class="info-description">Covering an area more than Khalifa Al Tajer Mosquethan 105,000 square feet, the Khalifa Al Tajer Mosque is the Middle East’s first eco-friendly mosque. Positioned in Deira, the mosque is to offer prayer and can house up to 3,500 worshippers. The Khalifa Al Tajer Mosque is made from green building materials, and is skillfully designed to use solar energy to power the lights, which makes use of air conditioners that emit reduced greenhouse gases and boasts thermal-insulation systems for lowering energy consumption.
                ...
                The Khalifa Al Tajer Mosque is the Middle East’s first eco-friendly mosque. Positioned in Deira, the mosque is to offer prayer and can house up to 3,500 worshippers. The Khalifa Al Tajer Mosque is made from green building materials, and is skillfully designed to use solar energy to power the lights, which makes use of air conditioners that emit reduced greenhouse gases and boasts thermal-insulation systems for lowering energy consumption.

                <br><br>

                The motivation for the mosque’s creation is encapsulated in the words of the Secretary-General of Dubai’s Awqaf and Minors Affairs Foundation, Tayeb Al Rais, who stated at the mosque’s opening, “Environmental awareness is a pillar of Islam. We hope the mosque reminds worshippers of their duties towards the environment.” The building of the Khalifa Al Tajer Mosque follows several major green architectural incentives in the UAE, including plans for Dubai’s Sustainable City and most notably, Masdar City.
        ...
        <div class="blackbg">
        <img src="images/dubai/mosque/khalif7.JPG" class="wtd-bg"/> <!-- the bg for the entirety of the what to do part -->
        </div>
        <div class="scroller-area">
            ...
            <div class="contents-box">
                ...
                <p class="contents-desc1">The Khalifa Al Tajer Mosque is the Middle East's first eco-friendly mosque.</p>
                 </div>
            </div> 
            ...
            <div class="contents-box">
                ...
                <p class="contents-desc">
                Dubai's Awqaf and Minors Affairs Foundation (AMAF) opened the first environmentally friendly mosque in the entire Islamic world to worshippers. </p> <!-- put the actual activities here -->
                 </div>
            </div> 
        </div>
        </div>
    ...
    <iframe src="https://www.google.com/maps/embed?pb=!4v1622854841198!6m8!1m7!1sCAoSLEFGMVFpcFByMDZhYTh3emdOaHRPaFFJaUZZZXZJRDVHV29NNF8wOEhYaE1B!2m2!1d25.2554089!2d55.3291578!3f248.57228928429552!4f-1.9154090281541727!5f0.7820865974627469" width="100%" height="1000px" style="border:0;" allowfullscreen="" loading="lazy"></iframe>
    <!-- google maps -->   
    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3608.451025523756!2d55.3291578!3d25.2554089!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3e5f5cd90635bcc1%3A0x15bfa2a7644bbb0e!2sKhalifa%20Altajir%20Mosque!5e0!3m2!1sen!2sae!4v1622854864882!5m2!1sen!2sae"
...
<!-- -->
    ...
    <section id="media-wrappper">
        ...
        <div class="row row1">
            <div class="img-media"><img src="images/dubai/mosque/khalif1.jpg" class="fiximg" />
            <p> Outside of Khalifa Al Tajer Mosque </p>
            </div>

            <div class="img-media"><img src="images/dubai/mosque/khalif2.JPG" class="fiximg" />
            <p> Outside of Khalifa Al Tajer Mosque </p>
            </div>

            <div class="img-media"><img src="images/dubai/mosque/khalif3.jpg" class="fiximg" />
            <p> Interior of Khalifa Al Tajer Mosque </p>
            </div>

            <div class="img-media"><img src="images/dubai/mosque/khalif5.JPG" class="fiximg" />
            <p> Khalifa Al Tajer Mosque</p>
            </div>

            <div class="img-media"><img src="images/dubai/mosque/khalif4.jpg" class="fiximg" />
            <p> People going to mosque </p>
            </div>
