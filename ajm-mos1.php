...
<div id="navbar"> 
        ...
        <div class="title-container">
            <div class="another-container1">
                <div class="title-slider"> <!-- images the one sa top left -->
                        <div><img src="images\ajm-pictures\Mosque\Sheikh Zayed Mosque\ajmmos1A.jpg" class="picture" /></div>
                        <div><img src="images\ajm-pictures\Mosque\Sheikh Zayed Mosque\ajmmos1C.jpg" class="picture" /></div>
                        <div><img src="images\ajm-pictures\Mosque\Sheikh Zayed Mosque\ajmmos1D.jpg" class="picture" /></div>
                </div>
            </div>
    ...
    <div class="wrapper2">
        <div class="info-hist-box" id="history">
         ...
         <div class="layer1">
            ...
            <h2 class="info-title"> Information </h2> <!-- images on the left -->
                <div class="img-set"><img src="images\ajm-pictures\Mosque\Sheikh Zayed Mosque\ajmmos1B.jpg" class="smallimg"/></div>
                <div class="img-set"><img src="images\ajm-pictures\Mosque\Sheikh Zayed Mosque\ajmmos1C.jpg" class="smallimg"/></div>
                <div class="img-set"><img src="images\ajm-pictures\Mosque\Sheikh Zayed Mosque\ajmmos1G.jpg" class="smallimg"/></div>
            </div>
            <div class="info-container">
                <div class="dl-bm">
                    ...
                    <a href="download\Ajman\Mosque\Sheikh Zayed Mosque.docx"> 
                    <button><img src="images/Desktop Download.png"/></button>
                    </a>
                    
                </div>
            <h2 class="info-title1"> Information </h2> <!-- description feel free to add per paragraph -->
                <p class="info-description"> Among all the religious institutions of Ajman, Sheikh Zayed Ajman Mosque stands high on the 
                itinerary of the emirate with its remarkable and intrinsic architecture. Built in the memory of Late Sheikh Rashid bin Humaid 
                Al Nuaimi by the current leader of Ajman and his son Humaid bin Rashid Al Nuaimi, the mosque is a flagship building of the city.
                   ...
                   According to various sources, it is believed that this mosque was built for the late Sheikh Rashid bin Humaid Al Nuaimi 
                   by his son, Humaid bin Rashid Al Nuaimi, the Ruler of Ajman. The intrinsic architecture of this mosque has made it a flagship 
                   building of Ajman. Built on a sprawling area of 37000 sq. meters, the sacred mosque can accommodate 2500 worshippers at a time.
        ...
        <div class="blackbg">
        <img src="images\ajm-pictures\Mosque\Sheikh Zayed Mosque\ajmmos1C.jpg" class="wtd-bg"/> <!-- the bg for the entirety of the what to do part -->
        </div>
        <div class="scroller-area">
            ...
            <div class="contents-box">
                ...
                <p class="contents-desc1">Although the Emirate of Ajman has many religious sites, the Sheikh Zayed Ajman Mosque is the most famous religious 
                site. This mosque has a rich architecture which is incredibly impressive with four minarets and a singular dome. </p>
                 </div>
            </div> 
            
            <div class="contents-box">
                <div class="contents-img">
                    <img src="images\ajm-pictures\Mosque\Sheikh Zayed Mosque\ajmmos1E.jpg" />
                </div>
                <div class="contents-container">
                <h2 class="contents-title"> Architecture </h2>
                <p class="contents-desc">One of the major Ajman tourist attractions, the Sheikh Zayed Mosque is an impressive traditional architecture of 
                sacred importance.</p> <!-- put the actual activities here -->
                 </div>
            </div> 

            <div class="contents-box">
                <div class="contents-img">
                    <img src="images\ajm-pictures\Mosque\Sheikh Zayed Mosque\ajmmos1F.jpg" />
                </div>
                <div class="contents-container">
                <h2 class="contents-title"> Memories </h2>
                <p class="contents-desc"> With a building this impressive, don’t forget to bring your camera! Frame this experience of yours by taking 
                pictures. </p> <!-- put the actual activities here -->
                 </div>
            </div>
    ...
    <!-- google maps -->   
    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d28830.494655025133!2d55.483925083920084!3d25.411108513000567!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3e5f580057bfe831%3A0x93c9fffcfb459b60!2sSheikh%20Zayed%20Mosque!5e0!3m2!1sen!2sae!4v1622721220027!5m2!1sen!2sae"
...
<!-- -->
    ...
    <section id="media-wrappper">
        ...
        <div class="row row1">
            <div class="img-media"><img src="images\ajm-pictures\Mosque\Sheikh Zayed Mosque\ajmmos1A.jpg"  class="fiximg" />
            <p> View of Sheikh Zayed Mosque </p>
            </div>

            <div class="img-media"><img src="images\ajm-pictures\Mosque\Sheikh Zayed Mosque\ajmmos1B.jpg" class="fiximg" />
            <p> View of Sheikh Zayed Mosque </p>
            </div>

            <div class="img-media"><img src="images\ajm-pictures\Mosque\Sheikh Zayed Mosque\ajmmos1C.jpg"  class="fiximg" />
            <p> Close up view of Sheikh Zayed Mosque </p>
            </div>

            <div class="img-media"><img src="images\ajm-pictures\Mosque\Sheikh Zayed Mosque\ajmmos1D.jpg"  class="fiximg" />
            <p> View of Sheikh Zayed Mosque </p>
            </div>

            <div class="img-media"><img src="images\ajm-pictures\Mosque\Sheikh Zayed Mosque\ajmmos1E.jpg"  class="fiximg" />
            <p> Overview of Sheikh Zayed Mosque </p>
            </div>

        </div>

        <div class="row row2">
        <div class="img-media"><img src="images\ajm-pictures\Mosque\Sheikh Zayed Mosque\ajmmos1F.jpg"  class="fiximg" />
        <p> View of Sheikh Zayed Mosque at night time </p>
            </div>

            <div class="img-media"><img src="images\ajm-pictures\Mosque\Sheikh Zayed Mosque\ajmmos1G.jpg"  class="fiximg" />
            <p> View of Sheikh Zayed Mosque at dawn </p>
            </div>

            <div class="img-media"><img src="images\ajm-pictures\Mosque\Sheikh Zayed Mosque\ajmmos1H.jpg"  class="fiximg" />
            <p> View of Sheikh Zayed Mosque </p>
            </div>
    ...
    <script>
        ...
        function sun(){
            ...
            $('#t-time').html( ' 9:00 AM - 10:00 PM ' );  //so put the timings here
        ...
        function fri(){
            $('#timing-info').hide().fadeIn();
            $('#t-time').html( ' 4:30 AM - 10:00 PM ' ); //so put the timings here
