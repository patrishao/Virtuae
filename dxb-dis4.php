...
<div id="navbar"> 
        ...
        <div class="title-container">
            <div class="another-container1">
                <div class="title-slider"> <!-- images the one sa top left -->
                        <div><img src="images/dubai/dxbdis4C.jpg" class="picture" /></div>
                        <div><img src="images/dubai/discover/dxbdis4D.jpg" class="picture" /></div>
                        <div><img src="images/dubai/discover/dxbdis4H.jpg" class="picture" /></div>
                </div>
            </div>
            <div class="another-container">
                <h1 class="title1"> Etihad Museum </h1> <!-- title -->
    ...
    <div class="wrapper2">
        <div class="info-hist-box" id="history">
         ...
         <div class="layer1">
            ...
            <h2 class="info-title"> Information </h2> <!-- images on the left -->
                <div class="img-set"><img src="images/dubai/discover/dxbdis4A.jpg" style="object-position: 0 -50px;" class="smallimg"/></div>
                <div class="img-set"><img src="images/dubai/discover/dxbdis4B.jpg" style="object-position: 0 -50px;" class="smallimg"/></div>
                <div class="img-set"><img src="images/dubai/discover/dxbdis4E.jpg" style="object-position: 0 -50px;" class="smallimg"/></div>
            </div>
        ...
        <div class="blackbg">
        <img src="images/dubai/discover/dxbdis4F.jpg" class="wtd-bg"/> <!-- the bg for the entirety of the what to do part -->
        </div>
        <div class="scroller-area">
            ...
            <div class="contents-box">
                ...
                <p class="contents-desc1">The Etihad Museum, historically called the Union House, is a museum in Dubai that collects, preserves, and displays the heritage of the United Arab Emirates.</p>
                 </div>
            </div> 
            
            <div class="contents-box">
                <div class="contents-img">
                    <img src="images/dubai/discover/dxbdis4G.jpg"/>
                </div>
                <div class="contents-container">
                <h2 class="contents-title"> Explore </h2>
                <p class="contents-desc">
                Discover the UAE’s rich heritage before the treaty that unified the seven emirates was signed. </p> <!-- put the actual activities here -->
                 </div>
            </div> 
            <div class="contents-box">
                <div class="contents-img">
                    <img src="images/dubai/discover/dxbdis4H.jpg"/>
                </div>
                <div class="contents-container">
                <h2 class="contents-title"> Learn </h2>
                <p class="contents-desc">
                The main purpose of the museum is to collect, preserve, and interpret the material and other findings.</p> <!-- put the actual activities here -->
                </div>
            </div>
        </div>
        </div>
    ...
    <iframe src="https://www.google.com/maps/embed?pb=!4v1622835172484!6m8!1m7!1sCAoSLEFGMVFpcE5MMlBzRGE5MFNoVWZ2NjFmX01mbjZabnc4V3ZJT0xxQU1JUzVS!2m2!1d25.24135597350935!2d55.26984098974424!3f353.45083957454!4f21.279736785889483!5f0.4000000000000002" width="100%" height="1000px" style="border:0;" allowfullscreen="" loading="lazy"></iframe>
    <!-- google maps -->   
    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3608.868433063333!2d55.26984098974424!3d25.24135597350935!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3e5f43aa42d52ffb%3A0x763583ec320718d6!2sEtihad%20Museum!5e0!3m2!1sen!2sae!4v1622835201189!5m2!1sen!2sae"
...
<!-- -->
    ...
    <section id="media-wrappper">
        ...
        <div class="row row1">
            <div class="img-media"><img src="images/dubai/discover/dxbdis4C.jpg" class="fiximg" />
            <p> Etihad Museum </p>
            </div>

            <div class="img-media"><img src="images/dubai/discover/dxbdis4A.JPG" class="fiximg" />
            <p> Etihad Museum </p>
            </div>

            <div class="img-media"><img src="images/dubai/discover/dxbdis4B.JPG" class="fiximg" />
            <p> Etihad Museum </p>
            </div>

            <div class="img-media"><img src="images/dubai/discover/dxbdis4F.jpg" class="fiximg" />
            <p> Etihad Museum </p>
            </div>

            <div class="img-media"><img src="images/dubai/discover/dxbdis4D.jpg" class="fiximg" />
            <p> Etihad Museum </p>
            </div>
