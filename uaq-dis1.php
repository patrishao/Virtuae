...
<div id="navbar"> 
        ...
        <div class="title-container">
            <div class="another-container1">
                <div class="title-slider"> <!-- images the one sa top left -->
                        <div><img src="images/umm al quwain/Discover/Abandoned IL-76/uaqdisA1.JPG" class="picture" /></div>
                        <div><img src="images/umm al quwain/Discover/Abandoned IL-76/uaqdisA2.JPG" class="picture" /></div>
                        <div><img src="images/umm al quwain/Discover/Abandoned IL-76/uaqdisA3.JPG" class="picture" /></div>
                </div>
            </div>
            <div class="another-container">
                <h1 class="title1"> Abandoned IL-76 </h1> <!-- title -->
    ...
    <div class="wrapper2">
        <div class="info-hist-box" id="history">
         ...
         <div class="layer1">
            ...
            <h2 class="info-title"> Information </h2> <!-- images on the left -->
                <div class="img-set"><img src="images/umm al quwain/Discover/Abandoned IL-76/uaqdisA4.JPG" class="smallimg"/></div>
                <div class="img-set"><img src="images/umm al quwain/Discover/Abandoned IL-76/uaqdisA5.JPG" class="smallimg"/></div>
                <div class="img-set"><img src="images/umm al quwain/Discover/Abandoned IL-76/uaqdisA6.JPG" class="smallimg"/></div>
            </div>
            <div class="info-container">
                <div class="dl-bm">
                    ...
                    <a href="download/Umm Al Quwain/Discovery/Abandoned IL-76.docx"> 
                    <button><img src="images/Desktop Download.png"/></button>
                    </a>
                    
                </div>
            <h2 class="info-title1"> Information </h2> <!-- description feel free to add per paragraph -->
                <p class="info-description"> Abandoned IL-76 is a Russian cargoplane that was left abandoned and rusting away since probably 
                the 1970s at a non-functional airstrip in Umm al-Quwain.


                    <br>
                    <br>
                    
                    This soviet-era abandoned cargo plane might as well be the most interesting object in Umm Al Quwain. The plane is currently 
                    used as a billboard for the Palma Beach Hotel. The engines are long gone and its wings have begun to rust. The stories that 
                    accompany the aircraft and its history are all equally strange.
                   ...
                   The Soviet plane, according to the Aero Transport Data Bank, was built in 1975 in Uzbekistan, following which it flew as a Soviet 
                   military transport plane. In the early nineties, it was sold to the Air Ces a company formed by Sergei Bout in Belgium that moved 
                   to Sharjah in 1997.  

                   <br>
                   <br>

                   The cargo plane, owned by the brother of arms dealer Viktor Bout, was transferred to a company called Air Pass. This company was 
                   disbanded when South Africa's Civil Aviation Authority charged Air Cess with 146 breaches of civil aviation law.
                   
                   <br>
                   <br>

                   The plane, listed as "derelict" under the Centrafrican Airlines, 1998 to 2000, ended operations in 2001. However, it is said to have 
                   been bought by someone who transformed it into a café shop.
        ...
        <div class="blackbg">
        <img src="images/umm al quwain/Discover/Abandoned IL-76/uaqdisA7.JPG" class="wtd-bg"/> <!-- the bg for the entirety of the what to do part -->
        </div>
        <div class="scroller-area">
            ...
            <div class="contents-box">
                ...
                There’s nothing much to do in the Abandoned IL-76 but explore aircraft itself.
            ...
            <div class="contents-box">
                <div class="contents-img">
                    <img src="images/umm al quwain/Discover/Abandoned IL-76/uaqdisA3.JPG" />
                </div>
                ...
                Take a quick stop and take pictures, after all who would want to miss this historical place?
    ...
    <h2 class="vt-title">TOUR & LOCATION</h2>
      ...
      <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3598.47858123983!2d55.65977872026586!3d25.589008697751545!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3ef5fcd7b547266b%3A0x8afe5187d3b0c3b1!2sDreamland%20Aqua%20Park!5e0!3m2!1sen!2sae!4v1622869525310!5m2!1sen!2sae" width="100%" height="500px" style="border:0;" allowfullscreen="" loading="lazy"></iframe>    
...
<!-- -->
    ...
    <section id="media-wrappper">
        ...
        <div class="row row1">
            <div class="img-media"><img src="images/umm al quwain/Discover/Abandoned IL-76/uaqdisA1.JPG" class="fiximg" />
            <p> The plane itself </p>
            </div>

            <div class="img-media"><img src="images/umm al quwain/Discover/Abandoned IL-76/uaqdisA2.JPG" class="fiximg" />
            <p> Drone shot of the plane </p>
            </div>
            
            <div class="img-media"><img src="images/umm al quwain/Discover/Abandoned IL-76/uaqdisA3.JPG" class="fiximg" />
            <p> The plane with a guy on top of it </p>
            </div>

            <div class="img-media"><img src="images/umm al quwain/Discover/Abandoned IL-76/uaqdisA4.JPG" class="fiximg" />
            <p> The plane itself </p>
            </div>
            
            <div class="img-media"><img src="images/umm al quwain/Discover/Abandoned IL-76/uaqdisA5.JPG" class="fiximg" />
            <p> Drone shot of the plane </p>
            </div>
        ...
        <div class="row row2">
            <div class="img-media"><img src="images/umm al quwain/Discover/Abandoned IL-76/uaqdisA6.JPG" class="fiximg" />
            <p> Drone shot of the plane </p>
            </div>

            <div class="img-media"><img src="images/umm al quwain/Discover/Abandoned IL-76/uaqdisA7.JPG" class="fiximg" />
            <p> The plane itself </p>
            </div>
            
            <div class="img-media"><img src="images/umm al quwain/Discover/Abandoned IL-76/uaqdisA8.JPG" class="fiximg" />
            <p> The plane itself </p>
            </div>
