...
<head>
    ...
    <title> Bassata Desert Village </title>
...
<div id="navbar"> 
        ...
        <div class="title-container">
            <div class="another-container1">
                <div class="title-slider"> <!-- images the one sa top left -->
                        <div><img src="images/RAK/Activities/Bassata Desert Village/rakact5G.jpg" class="picture" /></div>
                        <div><img src="images/RAK/Activities/Bassata Desert Village/rakact5D.jpg" class="picture" /></div>
                        <div><img src="images/RAK/Activities/Bassata Desert Village/rakact5C.jpg" class="picture" /></div>
                </div>
            </div>
            <div class="another-container">
                <h1 class="title1"> Bassata Desert Village  </h1> <!-- title -->
    ...
    <div class="wrapper2">
        <div class="info-hist-box" id="history">
         ...
         <div class="layer1">
            ...
            <h2 class="info-title"> Information </h2> <!-- images on the left -->
                <div class="img-set"><img src="images/RAK/Activities/Bassata Desert Village/rakact5F.jpg" class="smallimg"/></div>
                <div class="img-set"><img src="images/RAK/Activities/Bassata Desert Village/rakact5A.jpg" class="smallimg"/></div>
                <div class="img-set"><img src="images/RAK/Activities/Bassata Desert Village/rakact5H.jpg" class="smallimg"/></div>
            </div>
            <div class="info-container">
                <div class="dl-bm">
                    ...
                    <a href="download/Ras Al Khaimah/Activities/Bassata Desert Village.docx"> 
                    <button><img src="images/Desktop Download.png"/></button>
                    </a>
                    
                </div>
            <h2 class="info-title1"> Information </h2> <!-- description feel free to add per paragraph -->
                <p class="info-description"> Bassata is an Arabic word for simplicity. Venture around the desert and you will find the entire camp reflecting simplicity.
                     Bassata Village is a stretch of sand where you can enjoy adrenaline-fuelled dune bashing and other exciting desert-based activities. 
                     The place has a wide range of tents where you can relax, soak up the sun and enjoy sunset views.

                    <br>
                    <br>
                    There is a child in all of us that is always in pursuit of an adventure. Somewhere exciting to go and experience something new and fun. Sinbad,
                     Ali Baba and the 40 Thieves, 1001 Arabian Nights are all tales made us dream of our own Arabian Nights adventure. The adventure that most may think of 
                     when coming to Arabia is to live like the Bedouins; in the desert and a tent, living with camels, and nights around the campfire telling stories and enriching 
                     ourselves with the culture of the people.
        ...
        <div class="blackbg">
        <img src="images/RAK/Activities/Bassata Desert Village/rakact5D.jpg" class="wtd-bg"/> <!-- the bg for the entirety of the what to do part -->
        </div>
        <div class="scroller-area">
            ...
            <div class="contents-box">
                ...
                <p class="contents-desc1">   Immerse yourself in the culture of the land and live like the Bedouins did at the Bassata Desert Village. 
                    An authentic replication of a bygone era, at the Bassata Desert Village, you live like a true Bedouin: in tents, with camels, and nights around a camp fire,
                     under the stars. </p>
                 </div>
            </div> 
            ...
            <div class="contents-box">
                <div class="contents-img">
                    <img src="images/RAK/Activities/Bassata Desert Village/rakact5E.jpg" />
                </div>
                <div class="contents-container">
                <h2 class="contents-title"> Adventure </h2>
                <p class="contents-desc">
                    The first and foremost thing to do in Bassata Village is to explore the vast and spectacular desert. 
                    Take an adventurous excursion around the village and catch a stunning view.
            ...
            <div class="contents-box">
                <div class="contents-img">
                <img src="images/RAK/Activities/Bassata Desert Village/rakact5D.jpg" />
                </div>
                <div class="contents-container">
                <h2 class="contents-title"> Sandboarding </h2>
                <p class="contents-desc"> Amidst dunes of sand, experience the thrill of sandboarding in Bassata Village. 
                    Sandboarding is an adventurous sport where you have to ride across a desert while standing on a specialised board.</p> <!-- put the actual activities here -->
                 </div>
            </div> 
              ...
              <div class="contents-box">
                <div class="contents-img">
                <img src="images/RAK/Activities/Bassata Desert Village/rakact5G.jpg" />
                </div>
                <div class="contents-container">
                <h2 class="contents-title"> Camel Riding </h2>
                <p class="contents-desc"> <br> <br>
                Camels are an integral part of Arab heritage. You can feel the true essence of 
                Emirati culture while riding the camels at Bassata Village</p> 
            ...
            <div class="contents-box">
                <div class="contents-img">
                <img src="images/RAK/Activities/Bassata Desert Village/rakact5B.jpg" />
                </div>
                <div class="contents-container">
                <h2 class="contents-title"> Barbecue </h2>
                <p class="contents-desc">You can enjoy a live barbecue at Bassata Village. Set a barbecue grill and cook succulent meaty treats for your family and friends at the village.</p> 
                     <!-- put the actual activities here -->
                 </div>
            </div> 
    ...
    <iframe width="100%" height="1000px" src="https://poly.google.com/view/5M0f0d7mTeM/embed?chrome=min" frameborder="0" style="border:none;" allowvr="yes" allow="vr;
    ...
    <br>
     <!-- google maps -->   
     <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1799.6872969978563!2d55.82304224967523!3d25.559201326688292!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3ef5e70d46879c63%3A0x7183ab60035e32d8!2sBassata%20Village!5e0!3m2!1sen!2sae!4v1622741740777!5m2!1sen!2sae" 
...
<!-- -->
    ...
    <section id="media-wrappper">
        ...
        <div class="row row1">
            <div class="img-media">
            <img src="images/RAK/Activities/Bassata Desert Village/rakact5A.jpg" class="fiximg" />
            <p> Full view of the desert </p>
            </div>
            
            <div class="img-media"><img src="images/RAK/Activities/Bassata Desert Village/rakact5B.jpg" class="fiximg" />
            <p> Outdoor kitchen area</p>
            </div>

            <div class="img-media"><img src="images/RAK/Activities/Bassata Desert Village/rakact5C.jpg" class="fiximg" />
            <p> Horse-riding activity </p>
            </div>

            <div class="img-media"><img src="images/RAK/Activities/Bassata Desert Village/rakact5D.jpg" class="fiximg" />
            <p>Backside of the desert</p>
            </div>
            
            <div class="img-media"><img src="images/RAK/Activities/Bassata Desert Village/rakact5E.jpg" class="fiximg" />
            <p> View of the dining area</p>
            </div>
        
        </div>

        <div class="row row2">
            <div class="img-media"><img src="images/RAK/Activities/Bassata Desert Village/rakact5F.jpg" class="fiximg" />
            <p> View of the dining area </p>
            </div>

            <div class="img-media"><img src="images/RAK/Activities/Bassata Desert Village/rakact5G.jpg" class="fiximg" />
            <p> Camels in the desert</p>
            </div>

            <div class="img-media"><img src="images/RAK/Activities/Bassata Desert Village/rakact5H.jpg" class="fiximg" />
            <p> Covered dining area </p>
            </div>

            <div class="img-media"><img src="images/RAK/Activities/Bassata Desert Village/rakact5A.jpg" class="fiximg" />
            <p> Full view of the desert </p>
            </div>
