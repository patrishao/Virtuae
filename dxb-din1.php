...
<head>
    ...
    <title>Morimoto Restaurant</title>
        ...
        <div class="title-container">
            <div class="another-container1">
                <div class="title-slider"> <!-- images the one sa top left -->
                        <div><img src="images/dubai/dxbdin1B.jpg" class="picture" /></div>
                        <div><img src="images/dubai/dine/dxbdin1A.jpg" class="picture" /></div>
                        <div><img src="images/dubai/dine/dxbdin1F.jpg" class="picture" /></div>
                </div>
            </div>
            <div class="another-container">
                <h1 class="title1"> Morimoto Restaurant </h1> <!-- title -->
         ...
         <div class="layer1">
            ...
            <div class="info-container">
                <div class="dl-bm">
                    ...
                    <a href="download/Dubai/Dine/Morimoto Restaurant .docx"> 
...
<!-- -->
    ...
    <section id="media-wrappper">
        ...
        <div class="row row1">
            <div class="img-media"><img src="images/dubai/dxbdin1B.jpg"  class="fiximg" />
            <p> Interior Design of Morimoto Restaurant </p>
            </div>

            <div class="img-media"><img src="images/dubai/dine/dxbdin1A.jpg"  class="fiximg" />
            <p> View outside the restaurant </p>
            </div>

            <div class="img-media"><img src="images/dubai/dine/dxbdin1E.jpg"  class="fiximg" />
            <p> Interior Design of Morimoto Restaurant </p>
            </div>

            <div class="img-media"><img src="images/dubai/dine/dxbdin1H.jpg"  class="fiximg" />
            <p> Food served in Morimoto Restaurant </p>
            </div>

            <div class="img-media"><img src="images/dubai/dine/IMG_2328.jpg"  class="fiximg" />
            <p> Food served in Morimoto Restaurant </p>
            </div>
    ...
    <script>
        ...
        function sun(){
            ...
            $('#t-time').html( '6:00 PM to 1:00 AM' ); //so put the timings here
        ...
        function thurs(){
            $('#timing-info').hide().fadeIn();
            $('#t-time').html(' 6:00 PM to 2:00 AM '); //so put the timings here
            
        }
        function fri(){
            $('#timing-info').hide().fadeIn();
            $('#t-time').html(' 1:00 PM to 4:00 PM 8:00 PM to 2:00 AM '); //so put the timings here
