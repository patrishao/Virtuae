...
<head>
    ...
    <title> Piaceri da Gustare </title>
...
<div id="navbar"> 
        ...
        <div class="title-container">
            <div class="another-container1">
                <div class="title-slider"> <!-- images the one sa top left -->
                        <div><img src="images/RAK/Dine/Piaceri Da Gustare/rakdin5A.jpg" class="picture" /></div>
                        <div><img src="images/RAK/Dine/Piaceri Da Gustare/rakdin5D.jpg" class="picture" /></div>
                        <div><img src="images/RAK/Dine/Piaceri Da Gustare/rakdin5G.jpg" class="picture" /></div>
                </div>
            </div>
            <div class="another-container">
                <h1 class="title1"> Piaceri da Gustare</h1> <!-- title -->
        ...
        <div class="info-hist-box" id="history">
         ...
         <div class="layer1">
            ...
            <h2 class="info-title"> Information </h2> <!-- images on the left -->
                <div class="img-set"><img src="images/RAK/Dine/Piaceri Da Gustare/rakdin5C.jpg" class="smallimg" style="object-position: 0 -80px;"/></div>
                <div class="img-set"><img src="images/RAK/Dine/Piaceri Da Gustare/rakdin5B.jpg" class="smallimg" style="object-position: 0 -350px;"/></div>
                <div class="img-set"><img src="images/RAK/Dine/Piaceri Da Gustare/rakdin5F.jpg" class="smallimg" style="object-position: 0 -80px;"/></div>
            ...
            <div class="info-container">
                <div class="dl-bm">
                    ...
                    <a href="download/Ras Al Khaimah/Dine/Piaceri da Gustare.docx"> 
            ...
            <h2 class="info-title1"> Information </h2> <!-- description feel free to add per paragraph -->
                ...
                da Gustare restaurant. Perfect for couples, the restaurant's wide selections of classic Italian dishes are a must-have during a trip to the Resort. Traditional
                 Italian desserts, gelato, and sorbets add a fitting end to the delicious meal.
                    <br>
                    <br>
    ...
    <!-- google maps -->   
    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3591.68589331633!2d55.955419415022035!3d25.81393478361303!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3ef6716aaf25b371%3A0xdf4a0e53e51dca11!2sPiaceri%20Da%20Gustare!5e0!3m2!1sen!2sae!4v1622804473353!5m2!1sen!2sae"
...
<!-- -->
    ...
    <section id="media-wrappper">
        ...
        <div class="row row1">
            <div class="img-media"><img src="images/RAK/Dine/Piaceri Da Gustare/rakdin5A.jpg" class="fiximg" />
            <p> Outdoor dining in Piaceri Da Gustare </p>
            </div>

            <div class="img-media"><img src="images/RAK/Dine/Piaceri Da Gustare/rakdin5B.jpg" class="fiximg" />
            <p> One of their finest main courses</p>
            </div>

            <div class="img-media"><img src="images/RAK/Dine/Piaceri Da Gustare/rakdin5C.jpg" class="fiximg" />
            <p> Indoor tables in Piaceri Da Gustare  </p>
            </div>

            <div class="img-media"><img src="images/RAK/Dine/Piaceri Da Gustare/rakdin5D.jpg" class="fiximg" />
            <p> Happy couple eating in the restaurant </p>
            </div>

            <div class="img-media"><img src="images/RAK/Dine/Piaceri Da Gustare/rakdin5E.jpg" class="fiximg" />
            <p> Outdoor pool </p>
            </div>

        </div>
        <div class="row row2">
            <div class="img-media"><img src="images/RAK/Dine/Piaceri Da Gustare/rakdin5F.jpg" class="fiximg" />
            <p>  Indoor view of the restaurant </p>
            </div>

            <div class="img-media"><img src="images/RAK/Dine/Piaceri Da Gustare/rakdin5G.jpg" class="fiximg" />
            <p> Indoor table view near the windows </p>
            </div>

            <div class="img-media"><img src="images/RAK/Dine/Piaceri Da Gustare/rakdin5H.jpg" class="fiximg" />
            <p> Outdoor tables </p>
            </div>
    ...
    <script>
        ...
        function sun(){
            ...
            $('#t-time').html(' 07:00 PM - 11:00 PM '); //so put the timings here
        ...
        function fri(){
            $('#timing-info').hide().fadeIn();
            $('#t-time').html(' 12:30 PM - 03:00 PM  07:00 PM - 11:00 PM'); //so put the timings here
