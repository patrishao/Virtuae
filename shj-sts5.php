...
<body>
        ...
        <div class="title-container">
            <div class="another-container1">
                <div class="title-slider"> <!-- images the one sa top left -->
                        <div><img src="images\shj-pictures\Sights to See\Gold Souk\shjsts5A.JPG" class="picture" /></div>
                        <div><img src="images\shj-pictures\Sights to See\Gold Souk\shjsts5B.JPG" class="picture" /></div>
                </div>
            </div>
            <div class="another-container">
                <h1 class="title1"> GOLD SOUK </h1> <!-- title -->
    ...
    <div class="wrapper2">
        <div class="info-hist-box" id="history">
         ...
         <div class="layer1">
            ...
            <h2 class="info-title"> Information </h2> <!-- images on the left -->
                <div class="img-set"><img src="images\shj-pictures\Sights to See\Gold Souk\shjsts5C.JPG" class="smallimg" style="width:1000px;"/></div>
                <div class="img-set"><img src="images\shj-pictures\Sights to See\Gold Souk\shjsts5D.JPG" class="smallimg"/></div>
                <div class="img-set"><img src="images\shj-pictures\Sights to See\Gold Souk\shjsts5E.JPG" class="smallimg"/></div>
            </div>
            <div class="info-container">
                <div class="dl-bm">
                    ...
                    <a href="download\Sharjah\Sights to See\Gold Souk.docx"> 
        ...
        <div class="blackbg">
        <img src="images\shj-pictures\Sights to See\Gold Souk\shjsts5G.jpg" class="wtd-bg"/> <!-- the bg for the entirety of the what to do part -->
        </div>
        <div class="scroller-area">
            ...
            <div class="contents-box">
                ...
                <p class="contents-desc1">The Central Souk consists of two large buildings, interconnected by bridges, with exuberant vaults and a unique skyline of 20 windtowers.</p>
                 </div>
            </div> 
            
            <div class="contents-box">
                <div class="contents-img">
                    <img src="images\shj-pictures\Sights to See\Gold Souk\shjsts5F.JPG" />
                </div>
                <div class="contents-container">
                <h2 class="contents-title"> Shopping </h2>
                <p class="contents-desc"> With over 600 shops across two levels, you’ll find everything from modern watches and clothing to authentically local trinkets and souvenirs. For decor connoisseurs in particular, the souk is one of the must-do Sharjah tourist places. </p> <!-- put the actual activities here -->
                 </div>
            </div> 
            
            <div class="contents-box">
                <div class="contents-img">
                    <img src="images\shj-pictures\Sights to See\Gold Souk\shjsts5C.JPG" />
                </div>
                <div class="contents-container">
                <h2 class="contents-title"> Jewelry </h2>
                <p class="contents-desc"> On the lagoon-side, you’ll find a glittering row of shops dedicated to authentic Bedouin jewelry, precious stones, gold and diamonds. Some craftsmen here can recreate a design based on just a sketch.
    ...
    <!-- to be replaced -->
    <!-- virtual tour -->
    <iframe width="100%" height="1000px" src="https://poly.google.com/view/7SI2ezGUwxM/embed?chrome=min" frameborder="0" style="border:none;" allowvr="yes" allow="vr; xr; accelerometer; magnetometer; gyroscope; autoplay;" allowfullscreen mozallowfullscreen="true" webkitallowfullscreen="true" onmousewheel="" ></iframe>
     <!-- google maps -->   
     <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d925453.6931604228!2d54.763679400252116!3d25.032258775986048!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3e5f5b4f269fc00f%3A0x6c409e85b284a25!2sSharjah%20Gold%20Souq!5e0!3m2!1sen!2sae!4v1622933464252!5m2!1sen!2sae" width="100%" height="500" style="border:0;" allowfullscreen="" loading="lazy"></iframe>
    ...
    <section id="media-wrappper">
        ...
        <div class="row row1">
            <div class="img-media">
                <img src="images\shj-pictures\Sights to See\Gold Souk\shjsts5A.JPG" class="fiximg" /> <!-- img! -->
                 <!-- description time, add smth like idk "fun time family!" -->
                <p> image of the souk </p>
            </div>
            
            <div class="img-media">
                <img src="images\shj-pictures\Sights to See\Gold Souk\shjsts5B.JPG" class="fiximg" /> <!-- img! -->
                 <!-- description time, add smth like idk "fun time family!" -->
                <p> another angle of the souk </p>
            </div>

            <div class="img-media">
                <img src="images\shj-pictures\Sights to See\Gold Souk\shjsts5C.JPG" class="fiximg" /> <!-- img! -->
                 <!-- description time, add smth like idk "fun time family!" -->
                <p> side shot of the souk </p>
            </div>

            <div class="img-media">
                <img src="images\shj-pictures\Sights to See\Gold Souk\shjsts5D.JPG" class="fiximg" /> <!-- img! -->
                 <!-- description time, add smth like idk "fun time family!" -->
                <p> full view of the souk </p>
            </div>

            <div class="img-media">
                <img src="images\shj-pictures\Sights to See\Gold Souk\shjsts5E.JPG" class="fiximg" /> <!-- img! -->
                 <!-- description time, add smth like idk "fun time family!" -->
                <p> front view of the souk </p>
            </div>
        </div>
        <div class="row row2">
            <div class="img-media">
                <img src="images\shj-pictures\Sights to See\Gold Souk\shjsts5F.JPG" class="fiximg" /> <!-- img! -->
                 <!-- description time, add smth like idk "fun time family!" -->
                <p> picure of inside the souk </p>
            </div>

            <div class="img-media">
                <img src="images\shj-pictures\Sights to See\Gold Souk\shjsts5G.jpg" class="fiximg" /> <!-- img! -->
                 <!-- description time, add smth like idk "fun time family!" -->
                <p> another picture inside the souk </p>
            </div>
    ...
    <script>
        ...
        function sun(){
            ...
            $('#t-time').html('Till 10:00PM'); //so put the timings here
