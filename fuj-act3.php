...
<body>
        ...
        <div class="title-container">
            <div class="another-container1">
                <div class="title-slider"> <!-- images the one sa top left -->
                        <div><img src="images\fuj-pictures\Entertainment\Snoopy Island\7544237a_z.JPG" class="picture" /></div>
                        <div><img src="images\fuj-pictures\Entertainment\Snoopy Island\296047904.JPG" class="picture" /></div>
                </div>
            </div>
            <div class="another-container">
                <h1 class="title1"> SNOOPY ISLAND </h1> <!-- title -->
    ...
    <div class="wrapper2">
        <div class="info-hist-box" id="history">
         ...
         <div class="layer1">
            ...
            <h2 class="info-title"> Information </h2> <!-- images on the left -->
                <div class="img-set"><img src="images\fuj-pictures\Entertainment\Snoopy Island\snoopy.JPG" class="smallimg"/></div>
                <div class="img-set"><img src="images\fuj-pictures\Entertainment\Snoopy Island\tt1116149_502614843153456_1413850988_o.JPG" class="smallimg"/></div>
                <div class="img-set"><img src="images\fuj-pictures\Entertainment\Snoopy Island\7544237a_z.JPG" class="smallimg"/></div>
            </div>
            <div class="info-container">
                <div class="dl-bm">
                    ...
                    <a href="download\Fujairah\Activities\Snoopy Island.docx"> 
            ...
            <h2 class="info-title1"> Information </h2> <!-- description feel free to add per paragraph -->
                ...
                A small rock island about 120m x 80m, Snoopy Island is named for the three sections of rock rising up to create a profile of feet, belly, and nose similar to the iconic image of Snoopy©️ sleeping on top of his doghouse! Enter from the shore, surface swim about 200m to the last buoy and drop down to 4-5m at the southwest corner. 
                Look for the resident Torpedo / Electric Ray buried in the sand near the buoy line anchor. Keep the rocks on your left as you glide over Grouper 
                resting on the rocks and coral clusters … along the rocks and coral, you can see Moray Eel, Trumpetfish, Arabian Boxfish, Parrotfish, Butterflyfish, Arabian Boxfish, Sergeant Major, Cardinalfish, Snapper, Picasso and Red Fanged Triggerfish, Broomtail Wrasse, Surgeonfish, Angelfish, Turtle, Nudibranch, and Cuttlefish.
                   ...
                   Snoopy Island, also called Snoopy Rock (because of the resemblance to the cartoon character Snoopy lying on his back) is a small rocky island off the northern coast of the Emirate of Fujairah (United Arab Emirates) on the Gulf of Oman. </p>                    
        ...
        <div class="blackbg">
        <img src="images\fuj-pictures\Entertainment\Snoopy Island\296047904.JPG" class="wtd-bg"/> <!-- the bg for the entirety of the what to do part -->
        </div>
        <div class="scroller-area">
            ...
            <div class="contents-box">
                ...
                <p class="contents-desc1">A haven for every visitor, from snorkelers to professional divers and the occasional honeymooners looking for tranquil destinations, Snoopy Island is one of the country’s best-kept secrets. </p>
                 </div>
            </div> 
            
            <div class="contents-box">
                <div class="contents-img">
                    <img src="images\fuj-pictures\Entertainment\Snoopy Island\296047904.JPG" />
                </div>
                <div class="contents-container">
                <h2 class="contents-title"> Diving </h2>
                <p class="contents-desc">Find a buddy, put on your gear, walk 40m and you are diving! Snoopy Island is a great shore dive. It is perfect for day and night dives. </p> <!-- put the actual activities here -->
                 </div>
            </div> 
            
            <div class="contents-box">
                <div class="contents-img">
                    <img src="images\fuj-pictures\Entertainment\Snoopy Island\snoopy.JPG" />
                </div>
                <div class="contents-container">
                <h2 class="contents-title"> Resorts </h2>
                <p class="contents-desc">The best way to experience the island in all its glory is with a stay at the Sandy Beach Hotel and Resort. While there are several other hotels near Snoopy Island Fujairah, this one deserves special mention.  </p> <!-- put the actual activities here -->
                 </div>
            </div> 
    ...
    <!-- to be replaced -->
    <!-- virtual tour -->
    <iframe width="100%" height="1000px" src="https://poly.google.com/view/8dgjr0Hbr1Z/embed?chrome=min"  
     ...
     <!-- google maps -->   
     <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d14405.535514835658!2d56.355411936462524!3d25.49224090885922!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3ef437e63e0a7139%3A0xa516978c39305aa2!2sJaz%C4%ABrat%20al%20Ghubbah!5e0!3m2!1sen!2sae!4v1622758601853!5m2!1sen!2sae" width="100%" height="500px" style="border:0;" allowfullscreen="" loading="lazy"></iframe>
    ...
    <section id="media-wrappper">
        ...
        <div class="row row1">
            <div class="img-media">
                <img src="images\fuj-pictures\Entertainment\Snoopy Island\7544237a_z.JPG" class="fiximg" /> <!-- img! -->
                 <!-- description time, add smth like idk "fun time family!" -->
                <p> a scenic view of snoopy island </p>
            </div>
            
            <div class="img-media">
                <img src="images\fuj-pictures\Entertainment\Snoopy Island\296047904.JPG" class="fiximg" /> <!-- img! -->
                 <!-- description time, add smth like idk "fun time family!" -->
                <p> the resort </p>
            </div>

            <div class="img-media">
                <img src="images\fuj-pictures\Entertainment\Snoopy Island\snoopy-island-4-1-780x470.JPG" class="fiximg" /> <!-- img! -->
                 <!-- description time, add smth like idk "fun time family!" -->
                <p> the island itself </p>
            </div>

            <div class="img-media">
                <img src="images\fuj-pictures\Entertainment\Snoopy Island\tt1116149_502614843153456_1413850988_o.JPG" class="fiximg" /> <!-- img! -->
                 <!-- description time, add smth like idk "fun time family!" -->
                <p> view of the resort and the island </p>
            </div>

            <div class="img-media">
                <img src="images\fuj-pictures\Entertainment\Snoopy Island\snoopy.JPG" class="fiximg" /> <!-- img! -->
                 <!-- description time, add smth like idk "fun time family!" -->
                <p> top view of the island and the resort</p>
            </div>
        </div>
        <div class="row row2">
            <div class="img-media">
