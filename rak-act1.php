...
<div id="navbar"> 
        ...
        <div class="title-container">
            <div class="another-container1">
                <div class="title-slider"> <!-- images the one sa top left -->
                        <div><img src="images/RAK/Activities/Al Manar Mall/rakent2A.jpg" class="picture" /></div>
                        <div><img src="images/RAK/Activities/Al Manar Mall/rakent2F.jpg" class="picture" /></div>
                        <div><img src="images/RAK/Activities/Al Manar Mall/rakent2G.jpg" class="picture" /></div>
                </div>
            </div>
            <div class="another-container">
                <h1 class="title1"> Al Manar Mall </h1> <!-- title -->
    ...
    <div class="wrapper2">
        <div class="info-hist-box" id="history">
         ...
         <div class="layer1">
            ...
            <h2 class="info-title"> Information </h2> <!-- images on the left -->
                <div class="img-set"><img src="images/RAK/Activities/Al Manar Mall//rakent2B.jpg" class="smallimg"/></div>
                <div class="img-set"><img src="images/RAK/Activities/Al Manar Mall//rakent2D.jpg" class="smallimg"/></div>
                <div class="img-set"><img src="images/RAK/Activities/Al Manar Mall//rakent2F.jpg" class="smallimg"/></div>
            </div>
            <div class="info-container">
                <div class="dl-bm">
                    ...
                    <a href="download/Ras Al Khaimah/Activities/Al Manar Mall.docx"> 
                    <button><img src="images/Desktop Download.png"/></button>
                    </a>
                    
                </div>
            <h2 class="info-title1"> Information </h2> <!-- description feel free to add per paragraph -->
                <p class="info-description"> Manar Mall is owned by Al Hamra Group, a leading real estate developer of the region.
                     It has become a favourite spot for shopping and leisure. For retail, grocery shopping, and entertainment, residents of 
                     RAK can head to the Manar Mall. 

                    <br>
                    <br>

                    Customers are offered cafes and restaurants with outdoor siting area, facing the sea, playgrounds for children, 120 retail
                    outlets and several anchor stores. A chance to sample Local and International fare in our dedicated food court awaits you.
                    12 outlets with over 600 seats offer a perfect place to sit back and relax for a sumptuous meal with family and friends. 
                    For those who prefer an eclectic choice of cuisine and mesmerizing ambience, we have four full service restaurants overlooking 
                    the mall’s corniche. Visually stunning and highly palatable, the ambience and food at the Manar mall makes you return for more.
                    ...
                    Al Manar Mall opened its' doors on September 2000 and caters to be the most popular shopping and leisure center in RAK.
                    </p>
        ...
        <div class="blackbg">
        <img src="images/RAK/Activities/Al Manar Mall/rakent2H.jpg" class="wtd-bg"/> <!-- the bg for the entirety of the what to do part -->
        </div>
        <div class="scroller-area">
            ...
            <div class="contents-box">
                ...
                <p class="contents-desc1">   Built on the spectacular landscape-facing sea corniche on one side and 
                    convenient parking on the other, it offers variety of time spending to everyone. It has countless 
            ...
            <div class="contents-box">
                <div class="contents-img">
                    <img src="images/RAK/Activities/Al Manar Mall/rakent2F.jpg" />
                </div>
                <div class="contents-container">
                <h2 class="contents-title"> Shop & Dine </h2>
                <p class="contents-desc">
                    <br>
                    <br>    
                At Manar Mall, you will love every step of your shopping experience; from popular high street shops to makeup brands,
                to furniture and DIY stores.
            ...
            <div class="contents-box">
                <div class="contents-img">
                <img src="images/RAK/Activities/Al Manar Mall/novo.jpg" />
                </div>
                <div class="contents-container">
                <h2 class="contents-title"> Cinema </h2>
                <p class="contents-desc"> Novo Cinemas offers the best movie experience, creating a lasting memory for every customer; 
                    so sit back and enjoy the movie.</p> <!-- put the actual activities here -->
                 </div>
            </div> 
              ...
              <div class="contents-box">
                <div class="contents-img">
                <img src="images/RAK/Activities/Al Manar Mall/rakent2D.jpg" />
                </div>
                <div class="contents-container">
                <h2 class="contents-title"> Tridom </h2>
                <p class="contents-desc">Tridom is a must try, featuring the tallest indoor drop tower in the Middle East, the first of
                     its kind ultimate family entertainment arena in Ras Al Khaimah along with other exciting thrilling rides!</p> 
    ...
    <iframe width="100%" height="1000px" src="https://poly.google.com/view/7PfXUN_53eG/embed?chrome=min" frameborder="0" style="border:none; overflow:hi" allowvr="yes" allow="vr; xr; accelerometer; magnetometer; gyroscope; autoplay;" 
    allowfullscreen mozallowfullscreen="true" webkitallowfullscreen="true" onmousewheel="" ></iframe>
    <br>
    <br>
     <!-- google maps -->   
     <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1796.2810115139534!2d55.96504531773327!3d25.78502624414439!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3ef676cf6480b709%3A0x171e34cdb3e2f642!2sAl%20Manar%20Mall%20-%20Ras%20al%20Khaimah!5e0!3m2!1sen!2sae!4v1622731885724!5m2!1sen!2sae" 
...
<!-- -->
    ...
    <section id="media-wrappper">
        ...
        <div class="row row1">
            <div class="img-media">
            <img src="images/RAK/Activities/Al Manar Mall/rakent2A.jpg" class="fiximg" class="fiximg" />
            <p> Full view of Al Manar Mall </p>
            </div>
            
            <div class="img-media"><img src="images/RAK/Activities/Al Manar Mall/rakent2B.jpg" class="fiximg" />
            <p> Indoor view of the mall </p>
            </div>

            <div class="img-media"><img src="images/RAK/Activities/Al Manar Mall/rakent2C.jpg" class="fiximg" />
            <p> Outdoor view of the mall </p>
            </div>

            <div class="img-media"><img src="images/RAK/Activities/Al Manar Mall/rakent2D.jpg" class="fiximg" />
            <p>Outdoor view of the Mall</p>
            </div>
            
            <div class="img-media"><img src="images/RAK/Activities/Al Manar Mall/rakent2E.jpg" class="fiximg" />
            <p> People walking around the mall </p>
            </div>
        
        </div>

        <div class="row row2">
            <div class="img-media"><img src="images/RAK/Activities/Al Manar Mall/rakent2F.jpg" class="fiximg" />
            <p> The food court </p>
            </div>

            <div class="img-media"><img src="images/RAK/Activities/Al Manar Mall/rakent2G.jpg" class="fiximg" />
            <p> People shopping in the mall </p>
            </div>

            <div class="img-media"><img src="images/RAK/Activities/Al Manar Mall/rakent2H.jpg" class="fiximg" />
            <p> Indoor view of the mall </p>
            </div>

            <div class="img-media"><img src="images/RAK/Activities/Al Manar Mall/rakent2A.jpg" class="fiximg" />
            <p> Full view of Al Manar Mall </p>
            </div>
