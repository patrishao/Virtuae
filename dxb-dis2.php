...
<head>
    ...
    <title>Al Shindagha Museum</title>
...
<div id="navbar"> 
        ...
        <div class="title-container">
            <div class="another-container1">
                <div class="title-slider"> <!-- images the one sa top left -->
                        <div><img src="images/dubai/dxbdis2G.jpg" class="picture" /></div>
                        <div><img src="images/dubai/discover/dxbdis2D.jpg" class="picture" /></div>
                        <div><img src="images/dubai/discover/dxbdis2F.jpg" class="picture" /></div>
                </div>
            </div>
            <div class="another-container">
                <h1 class="title1"> Al Shindagha Museum </h1> <!-- title -->
    ...
    <div class="wrapper2">
        <div class="info-hist-box" id="history">
         ...
         <div class="layer1">
            ...
            <h2 class="info-title"> Information </h2> <!-- images on the left -->
                <div class="img-set"><img src="images/dubai/discover/dxbdis2A.jpg" style="object-position: 0 -50px;" class="smallimg"/></div>
                <div class="img-set"><img src="images/dubai/discover/dxbdis2C.jpg" style="object-position: 0 -50px;" class="smallimg"/></div>
                <div class="img-set"><img src="images/dubai/discover/dxbdis2H.jpg" style="object-position: 0 -50px;" class="smallimg"/></div>
            </div>
            <div class="info-container">
                <div class="dl-bm">
                    ...
                    <a href="download/Dubai/Discover/Al Shindagha Museum.docx"> 
        ...
        <div class="blackbg">
        <img src="images/dubai/discover/dxbdis2G.jpg" class="wtd-bg"/> <!-- the bg for the entirety of the what to do part -->
        </div>
        <div class="scroller-area">
            ...
            <div class="contents-box">
                ...
                <p class="contents-desc1">Shindagha Museum tells the universal tale of human innovation, resilience, and the desire for progress which shaped the Dubai of nowadays.</p>
                 </div>
            </div> 
            
            <div class="contents-box">
                <div class="contents-img">
                    <img src="images/dubai/discover/dxbdis2E.jpg"/>
                </div>
                <div class="contents-container">
                <h2 class="contents-title"> Tour </h2>
                <p class="contents-desc">
                The carefully-curated tour features interactive videos, touch displays and historic photographs and artefacts so visitors can gain insight into what it was like for Emiratis to raise a family by the waterways, and how maritime trade affected their livelihoods.</p> <!-- put the actual activities here -->
                 </div>
            </div> 

            <div class="contents-box">
                <div class="contents-img">
                    <img src="images/dubai/discover/dxbdis2F.jpg"/>
                </div>
                <div class="contents-container">
                <h2 class="contents-title"> Explore </h2>
                <p class="contents-desc">
                One theory is that the village could have been a part of the Sha’bi housing project by the UAE government which endeavoured to provide the Bedouin population with well-constructed settlements.</p> <!-- put the actual activities here -->
                </div>
            </div>
        </div>
        </div>
    ...
    <iframe src="https://www.google.com/maps/embed?pb=!4v1622826739591!6m8!1m7!1sCAoSLEFGMVFpcE5YWGtwSVF6TWtOaXAyX3BQSFJWWG5zUkZzMDZ0UDJHSVpOVWZ4!2m2!1d25.26640291525361!2d55.28943023747046!3f36.77704035169495!4f-8.480938065034252!5f0.7820865974627469" width="100%" height="1000px" style="border:0;" allowfullscreen="" loading="lazy"></iframe>
    <!-- google maps -->   
    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3608.124324059693!2d55.28943023747046!3d25.26640291525361!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3e5f4382cb4fc3bf%3A0x4878787ac33f48ab!2sAlShindagha%20Museum!5e0!3m2!1sen!2sae!4v1622826767262!5m2!1sen!2sae"
...
<!-- -->
    ...
    <section id="media-wrappper">
        ...
        <div class="row row1">
            <div class="img-media"><img src="images/dubai/discover/dxbdis2G.jpg" class="fiximg" />
            <p> Learn the history of the nation </p>
            </div>

            <div class="img-media"><img src="images/dubai/discover/dxbdis2C.JPG" class="fiximg" />
            <p> Paintings </p>
            </div>

            <div class="img-media"><img src="images/dubai/discover/dxbdis2H.JPG" class="fiximg" />
            <p> Interior of Shindagha Museum </p>
            </div>

            <div class="img-media"><img src="images/dubai/discover/dxbdis2F.jpg" class="fiximg" />
            <p> Artifacts</p>
            </div>

            <div class="img-media"><img src="images/dubai/discover/dxbdis2E.jpg" class="fiximg" />
            <p> Artworks </p>
            </div>
